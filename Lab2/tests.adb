...
S:Ltests.getchar$c$1$10({1}SC:U),R,0,0,[]
S:Ltests.getchar_nw$c$1$12({1}SC:U),R,0,0,[]
...
S:Ltests.aligned_alloc$size$1$39({2}SI:U),E,0,0
S:Ltests.aligned_alloc$alignment$1$39({2}SI:U),E,0,0
S:Ltests.main$sloc0$1$0({2}SI:S),E,0,0
...
S:Ftests$__str_0$0$0({10}DA10d,SC:S),D,0,0
S:Ftests$__str_1$0$0({44}DA44d,SC:S),D,0,0
S:Ftests$__str_2$0$0({4}DA4d,SC:S),D,0,0
S:Ftests$__str_3$0$0({4}DA4d,SC:S),D,0,0

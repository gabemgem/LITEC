...
_i::
	.ds 1
Ltests.aligned_alloc$size$1$39==.
_aligned_alloc_PARM_2:
	.ds 2
Ltests.main$sloc0$1$0==.
_main_sloc0_1_0:
	.ds 2
;--------------------------------------------------------
...
;--------------------------------------------------------
	...
	C$tests.c$47$1$70 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:47: unsigned int counts=0;	//Timer counter
	clr	a
	mov	_counts,a
	mov	(_counts + 1),a
	C$tests.c$48$1$70 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:48: unsigned int temp=0;	//Temp counts value
	mov	_temp,a
	mov	(_temp + 1),a
	C$tests.c$49$1$70 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:49: unsigned char input=0;	//user input
;	1-genFromRTrack replaced	mov	_input,#0x00
	mov	_input,a
	C$tests.c$50$1$70 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:50: unsigned char speed=0;	//speed of game
;	1-genFromRTrack replaced	mov	_speed,#0x00
	mov	_speed,a
	C$tests.c$51$1$70 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:51: unsigned int wait=0;	//time of delays
	mov	_wait,a
	mov	(_wait + 1),a
	C$tests.c$52$1$70 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:52: unsigned int score=0;	//total score of game
	mov	_score,a
	mov	(_score + 1),a
	C$tests.c$53$1$70 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:53: unsigned int points=0;	//points from each try of the game
	mov	_points,a
	mov	(_points + 1),a
	C$tests.c$54$1$70 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:54: unsigned char num=0;	//random number for the game
;	1-genFromRTrack replaced	mov	_num,#0x00
	mov	_num,a
	C$tests.c$55$1$70 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:55: unsigned char i=0;		//variable for for-loops
...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$tests.c$59$1$12 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:59: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$tests.c$61$1$55 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:61: Sys_Init();
	lcall	_Sys_Init
	C$tests.c$62$1$55 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:62: Port_Init();
	lcall	_Port_Init
	C$tests.c$63$1$55 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:63: ADC_Init();
	lcall	_ADC_Init
	C$tests.c$64$1$55 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:64: Interrupt_Init();
	lcall	_Interrupt_Init
	C$tests.c$65$1$55 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:65: Timer_Init();
	lcall	_Timer_Init
	C$tests.c$67$1$55 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:67: putchar(' ');
	mov	dpl,#0x20
	lcall	_putchar
	C$tests.c$68$1$55 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:68: printf("\r\nStart\r\n");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
	C$tests.c$70$1$55 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:70: getchar();
	lcall	_getchar
	C$tests.c$72$1$55 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:72: LED0=LED1=LED2=1;
	setb	_LED2
	mov	c,_LED2
	mov	_LED1,c
	mov	c,_LED1
	mov	_LED0,c
	C$tests.c$73$1$55 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:73: BILED1=BILED1=1;
	setb	_BILED1
	mov	c,_BILED1
	mov	_BILED1,c
	C$tests.c$74$1$55 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:74: BUZZER=1;
	setb	_BUZZER
	C$tests.c$76$1$55 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:76: while(1) {
00102$:
	C$tests.c$77$2$56 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:77: printf("\rPBEnter:%u, PB0:%u, PB1:%u, PB2:%u, SS:%u\n", PBEnter, PB0, PB1, PB2, SS);
	mov	c,_SS
	clr	a
	rlc	a
	mov	r6,a
	...
	mov	sp,a
	C$tests.c$78$2$56 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:78: LED0=1;
	setb	_LED0
	C$tests.c$79$2$56 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:79: LED1=0;
	clr	_LED1
	C$tests.c$80$2$56 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:80: LED2=1;
	setb	_LED2
	sjmp	00102$
	C$tests.c$89$1$55 ==.
	XG$main$0$0 ==.
...
;------------------------------------------------------------
	G$Port_Init$0$0 ==.
	C$tests.c$92$1$55 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:92: void Port_Init(void) {		//initialize ports
;	-----------------------------------------
;	 function Port_Init
;	-----------------------------------------
_Port_Init:
	C$tests.c$94$1$58 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:94: P1MDOUT &= ~0x02;		//=>xxxx xx0x
	anl	_P1MDOUT,#0xfd
	C$tests.c$95$1$58 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:95: P1MDIN &= ~0x02;		//=>xxxx xx0x
	anl	_P1MDIN,#0xfd
	C$tests.c$96$1$58 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:96: P1 |= 0x02;				//=>xxxx xx1x
	orl	_P1,#0x02
	C$tests.c$99$1$58 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:99: P2MDOUT |= 0x08;		//=>xxxx 1xxx
	orl	_P2MDOUT,#0x08
	C$tests.c$100$1$58 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:100: P2MDOUT &= ~0x07;		//=>xxxx 1000
	anl	_P2MDOUT,#0xf8
	C$tests.c$101$1$58 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:101: P2 |= 0x07;				//=>xxxx x111
	orl	_P2,#0x07
	C$tests.c$104$1$58 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:104: P3MDOUT |= 0xF8;		//=>1111 1xxx
	orl	_P3MDOUT,#0xf8
	C$tests.c$105$1$58 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:105: P3MDOUT &= ~0x03;		//=>1111 1x00
	anl	_P3MDOUT,#0xfc
	C$tests.c$106$1$58 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:106: P3 |= 0x03;				//=>xxxx xx11
	orl	_P3,#0x03
	C$tests.c$107$1$58 ==.
	XG$Port_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	...
	C$tests.c$109$1$58 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:109: void Interrupt_Init(void) {	//initialize timer interrupt
;	-----------------------------------------
;	 function Interrupt_Init
;	-----------------------------------------
_Interrupt_Init:
	C$tests.c$110$1$60 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:110: IE |= 0x02;				//enable Timer0 Interrupt request
	orl	_IE,#0x02
	C$tests.c$111$1$60 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:111: EA = 1;					//enable global interrupts
	setb	_EA
	C$tests.c$112$1$60 ==.
...
;------------------------------------------------------------
	G$Timer_Init$0$0 ==.
	C$tests.c$114$1$60 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:114: void Timer_Init(void) {		//initialize timer
;	-----------------------------------------
;	 function Timer_Init
;	-----------------------------------------
_Timer_Init:
	C$tests.c$115$1$62 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:115: CKCON |= 0x08;  		// Timer0 uses SYSCLK as source
	orl	_CKCON,#0x08
	C$tests.c$116$1$62 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:116: TMOD &= 0xF0;   		// clear the 4 least significant bits
	anl	_TMOD,#0xf0
	C$tests.c$117$1$62 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:117: TMOD |= 0x01;   		// Timer0 in mode 1
	orl	_TMOD,#0x01
	C$tests.c$118$1$62 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:118: TR0 = 0;           		// Stop Timer0
	clr	_TR0
	C$tests.c$119$1$62 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:119: TMR0 = 0;           	// Clear high & low byte of T0
	clr	a
	mov	((_TMR0 >> 0) & 0xFF),a
	mov	((_TMR0 >> 8) & 0xFF),a
	C$tests.c$120$1$62 ==.
...
;------------------------------------------------------------
	G$ADC_Init$0$0 ==.
	C$tests.c$122$1$62 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:122: void ADC_Init(void) {		//initialize ADC
;	-----------------------------------------
;	 function ADC_Init
;	-----------------------------------------
_ADC_Init:
	C$tests.c$123$1$64 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:123: REF0CN = 0x03; 			//set Vref to use 2.4V
	mov	_REF0CN,#0x03
	C$tests.c$124$1$64 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:124: ADC1CF |= 0x01;			//set gain of 1
	orl	_ADC1CF,#0x01
	C$tests.c$125$1$64 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:125: ADC1CN = 0x80; 			//enable A/D converter
	mov	_ADC1CN,#0x80
	C$tests.c$127$1$64 ==.
	XG$ADC_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$Timer0_ISR$0$0 ==.
	C$tests.c$129$1$64 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:129: void Timer0_ISR(void) __interrupt 1 {//initialize Timer0 overflow interrupt
;	-----------------------------------------
;	 function Timer0_ISR
;	-----------------------------------------
_Timer0_ISR:
	...
	push	psw
	C$tests.c$130$1$66 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:130: TF0=0;					//clear interrupt flag
	clr	_TF0
	C$tests.c$131$1$66 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:131: counts++;				//increment counter variable
	inc	_counts
	clr	a
...
;------------------------------------------------------------
	G$ADC_Convert$0$0 ==.
	C$tests.c$134$1$66 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:134: void ADC_Convert(void) {	//get POT value
;	-----------------------------------------
;	 function ADC_Convert
;	-----------------------------------------
_ADC_Convert:
	C$tests.c$135$1$68 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:135: AMX1SL = 1;				//Set ADC to convert value on pin 1
	mov	_AMX1SL,#0x01
	C$tests.c$136$1$68 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:136: ADC1CN &= ~0x20;
	anl	_ADC1CN,#0xdf
	C$tests.c$137$1$68 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:137: ADC1CN |= 0x10;
	orl	_ADC1CN,#0x10
	C$tests.c$138$1$68 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:138: printf("\r\n1");
	mov	a,#___str_2
	push	acc
	mov	a,#(___str_2 >> 8)
	push	acc
	...
	dec	sp
	C$tests.c$139$1$68 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:139: while((ADC1CN & 0x20)==0x00);
00101$:
	mov	a,_ADC1CN
	jnb	acc.5,00101$
	C$tests.c$140$1$68 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:140: printf("\r\n2");
	mov	a,#___str_3
	push	acc
	mov	a,#(___str_3 >> 8)
	push	acc
	...
	dec	sp
	C$tests.c$141$1$68 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:141: speed = ADC1;
	mov	_speed,_ADC1
	C$tests.c$142$1$68 ==.
	XG$ADC_Convert$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$random$0$0 ==.
	C$tests.c$144$1$68 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:144: unsigned char random(void) {//get random value(0-7)
;	-----------------------------------------
;	 function random
;	-----------------------------------------
_random:
	C$tests.c$145$1$70 ==.
;	C:\SiLabs\LITEC\Lab2\tests.c:145: return (rand()%8); 		//return a random value between 0 and 7
	lcall	_rand
...
___str_1:
	.db 0x0d
	.ascii "PBEnter:%u, PB0:%u, PB1:%u, PB2:%u, SS:%u"
	.db 0x0a
	.db 0x00
Ftests$__str_2$0$0 == .
___str_2:

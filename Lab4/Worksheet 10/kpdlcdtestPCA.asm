...
;------------------------------------------------------------
;keypad                    Allocated to registers r6 r7 
;------------------------------------------------------------
	G$main$0$0 ==.
	C$kpdlcdtestPCA.c$37$1$113 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:37: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$kpdlcdtestPCA.c$41$1$122 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:41: Sys_Init();     // System Initialization - MUST BE 1st EXECUTABLE STATEMENT
	lcall	_Sys_Init
	C$kpdlcdtestPCA.c$42$1$122 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:42: Port_Init();    // Initialize ports 2 and 3 - XBR0 set to 0x05, UART0 & SMB
	lcall	_Port_Init
	C$kpdlcdtestPCA.c$43$1$122 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:43: Interrupt_Init();   // You may want to change XBR0 to match your SMB wiring
	lcall	_Interrupt_Init
	C$kpdlcdtestPCA.c$44$1$122 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:44: PCA_Init();
	lcall	_PCA_Init
	C$kpdlcdtestPCA.c$45$1$122 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:45: SMB0_Init();
	lcall	_SMB0_Init
	C$kpdlcdtestPCA.c$46$1$122 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:46: putchar('\r');  // Dummy write to serial port
	mov	dpl,#0x0d
	lcall	_putchar
	C$kpdlcdtestPCA.c$47$1$122 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:47: printf("\nStart\r\n");
	mov	a,#___str_3
	push	acc
	mov	a,#(___str_3 >> 8)
	push	acc
...
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:49: Counts = 0;
	clr	a
	mov	_Counts,a
	mov	(_Counts + 1),a
	C$kpdlcdtestPCA.c$50$1$122 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:50: while (Counts < 1); // Wait a long time (1s) for keypad & LCD to initialize
00101$:
	clr	c
	mov	a,_Counts
	subb	a,#0x01
...
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:52: lcd_clear();
	lcall	_lcd_clear
	C$kpdlcdtestPCA.c$53$1$122 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:53: lcd_print("Calibration:\nHello world!\n012_345_678:\nabc def ghij");
	mov	a,#___str_4
	push	acc
	mov	a,#(___str_4 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
	C$kpdlcdtestPCA.c$54$1$122 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:54: while (1)
00105$:
	C$kpdlcdtestPCA.c$57$2$123 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:57: keypad = kpd_input(1);
	mov	dpl,#0x01
	lcall	_kpd_input
	mov	r6,dpl
	mov	r7,dph
	C$kpdlcdtestPCA.c$58$2$123 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:58: pause();
	push	ar7
	push	ar6
	lcall	_pause
	C$kpdlcdtestPCA.c$60$2$123 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:60: lcd_clear();
	lcall	_lcd_clear
	pop	ar6
	pop	ar7
	C$kpdlcdtestPCA.c$61$2$123 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:61: lcd_print("Your key was:\n %u,  = Hex %X", keypad, keypad);
	push	ar7
	push	ar6
	push	ar6
	push	ar7
	...
	pop	ar6
	pop	ar7
	C$kpdlcdtestPCA.c$62$2$123 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:62: printf("\n\rYour key was: %d,  = Hex %X", keypad, keypad);
	push	ar6
	push	ar7
	push	ar6
	push	ar7
...
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:98: void Port_Init(void)	//0x05
;	-----------------------------------------
;	 function Port_Init
;	-----------------------------------------
_Port_Init:
	C$kpdlcdtestPCA.c$100$1$125 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:100: XBR0 = 0x1F;    // NOTE: SMB on P0.6, P0.7
	mov	_XBR0,#0x1f
	C$kpdlcdtestPCA.c$101$1$125 ==.
	XG$Port_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	...
	C$kpdlcdtestPCA.c$103$1$125 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:103: void Interrupt_Init(void)
;	-----------------------------------------
;	 function Interrupt_Init
;	-----------------------------------------
_Interrupt_Init:
	C$kpdlcdtestPCA.c$105$1$127 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:105: IE |= 0x02;
	orl	_IE,#0x02
	C$kpdlcdtestPCA.c$106$1$127 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:106: EIE1 |= 0x08;
	orl	_EIE1,#0x08
	C$kpdlcdtestPCA.c$107$1$127 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:107: EA = 1;
	setb	_EA
	C$kpdlcdtestPCA.c$108$1$127 ==.
...
;------------------------------------------------------------
	G$PCA_Init$0$0 ==.
	C$kpdlcdtestPCA.c$110$1$127 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:110: void PCA_Init(void)
;	-----------------------------------------
;	 function PCA_Init
;	-----------------------------------------
_PCA_Init:
	C$kpdlcdtestPCA.c$112$1$129 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:112: PCA0MD = 0x81;      // SYSCLK/12, enable CF interrupts, suspend when idle
	mov	_PCA0MD,#0x81
	C$kpdlcdtestPCA.c$114$1$129 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:114: PCA0CN |= 0x40;     // enable PCA
	orl	_PCA0CN,#0x40
	C$kpdlcdtestPCA.c$115$1$129 ==.
	XG$PCA_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$SMB0_Init$0$0 ==.
	C$kpdlcdtestPCA.c$117$1$129 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:117: void SMB0_Init(void)    // This was at the top, moved it here to call wait()
;	-----------------------------------------
;	 function SMB0_Init
;	-----------------------------------------
_SMB0_Init:
	C$kpdlcdtestPCA.c$119$1$131 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:119: SMB0CR = 0x93;      // Set SCL to 100KHz
	mov	_SMB0CR,#0x93
	C$kpdlcdtestPCA.c$120$1$131 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:120: ENSMB = 1;          // Enable SMBUS0
	setb	_ENSMB
	C$kpdlcdtestPCA.c$121$1$131 ==.
	XG$SMB0_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$PCA_ISR$0$0 ==.
	C$kpdlcdtestPCA.c$123$1$131 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:123: void PCA_ISR(void) __interrupt 9
;	-----------------------------------------
;	 function PCA_ISR
;	-----------------------------------------
_PCA_ISR:
	push	acc
	push	psw
	C$kpdlcdtestPCA.c$125$1$133 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:125: if (CF)
	C$kpdlcdtestPCA.c$127$2$134 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:127: CF = 0;                     // clear the interrupt flag
	jbc	_CF,00114$
	sjmp	00104$
00114$:
	C$kpdlcdtestPCA.c$128$2$134 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:128: nOverflows++;               // continuous overflow counter
	inc	_nOverflows
	clr	a
	cjne	a,_nOverflows,00115$
	inc	(_nOverflows + 1)
00115$:
	C$kpdlcdtestPCA.c$129$2$134 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:129: nCounts++;
	inc	_nCounts
	clr	a
	cjne	a,_nCounts,00116$
	inc	(_nCounts + 1)
00116$:
	C$kpdlcdtestPCA.c$130$2$134 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:130: PCA0L = PCA_START & 0xFF;   // low byte of start count
	mov	_PCA0L,#0x00
	C$kpdlcdtestPCA.c$131$2$134 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:131: PCA0H = PCA_START >> 8;     // high byte of start count
	mov	_PCA0H,#0x70
	C$kpdlcdtestPCA.c$132$2$134 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:132: if (nCounts > 50)
	clr	c
	mov	a,#0x32
	subb	a,_nCounts
	clr	a
	subb	a,(_nCounts + 1)
	jnc	00106$
	C$kpdlcdtestPCA.c$134$3$135 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:134: nCounts = 0;
	clr	a
	mov	_nCounts,a
	mov	(_nCounts + 1),a
	C$kpdlcdtestPCA.c$135$3$135 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:135: Counts++;               // seconds counter
	inc	_Counts
;	genFromRTrack removed	clr	a
	...
	sjmp	00106$
00104$:
	C$kpdlcdtestPCA.c$138$1$133 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:138: else PCA0CN &= 0xC0;           // clear all other 9-type interrupts
	anl	_PCA0CN,#0xc0
00106$:
	pop	psw
	pop	acc
	C$kpdlcdtestPCA.c$139$1$133 ==.
	XG$PCA_ISR$0$0 ==.
	reti
...
;------------------------------------------------------------
	G$pause$0$0 ==.
	C$kpdlcdtestPCA.c$141$1$133 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:141: void pause(void)
;	-----------------------------------------
;	 function pause
;	-----------------------------------------
_pause:
	C$kpdlcdtestPCA.c$143$1$137 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:143: nCounts = 0;
	clr	a
	mov	_nCounts,a
	mov	(_nCounts + 1),a
	C$kpdlcdtestPCA.c$144$1$137 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:144: while (nCounts < 1);// 1 count -> (65536-PCA_START) x 12/22118400 = 20ms
00101$:
	clr	c
	mov	a,_nCounts
	subb	a,#0x01
...
;------------------------------------------------------------
	G$wait$0$0 ==.
	C$kpdlcdtestPCA.c$147$1$137 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:147: void wait(void)
;	-----------------------------------------
;	 function wait
;	-----------------------------------------
_wait:
	C$kpdlcdtestPCA.c$149$1$139 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:149: nCounts = 0;
	clr	a
	mov	_nCounts,a
	mov	(_nCounts + 1),a
	C$kpdlcdtestPCA.c$150$1$139 ==.
;	C:\SiLabs\LITEC\Lab4\Worksheet 10\kpdlcdtestPCA.c:150: while (nCounts < 50);    // 50 counts -> 50 x 20ms = 1000ms
00101$:
	clr	c
	mov	a,_nCounts
	subb	a,#0x32

...
_Data2::
	.ds 3
Llab4Data.aligned_alloc$size$1$39==.
_aligned_alloc_PARM_2:
	.ds 2
Llab4Data.lcd_clear$NumBytes$1$85==.
_lcd_clear_NumBytes_1_85:
	.ds 1
Llab4Data.lcd_clear$Cmd$1$85==.
_lcd_clear_Cmd_1_85:
	.ds 2
Llab4Data.read_keypad$Data$1$86==.
_read_keypad_Data_1_86:
	.ds 2
Llab4Data.i2c_write_data$start_reg$1$105==.
_i2c_write_data_PARM_2:
	.ds 1
Llab4Data.i2c_write_data$buffer$1$105==.
_i2c_write_data_PARM_3:
	.ds 3
Llab4Data.i2c_write_data$num_bytes$1$105==.
_i2c_write_data_PARM_4:
	.ds 1
Llab4Data.i2c_read_data$start_reg$1$107==.
_i2c_read_data_PARM_2:
	.ds 1
Llab4Data.i2c_read_data$buffer$1$107==.
_i2c_read_data_PARM_3:
	.ds 3
Llab4Data.i2c_read_data$num_bytes$1$107==.
...
;--------------------------------------------------------
	...
	C$lab4Data.c$29$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:29: unsigned int PCA_start = 28671;
	mov	_PCA_start,#0xff
	mov	(_PCA_start + 1),#0x6f
	C$lab4Data.c$30$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:30: unsigned char ccount = 0;//counter for the compass
	mov	_ccount,#0x00
	C$lab4Data.c$31$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:31: unsigned char rcount = 0;//counter for the ranger
	mov	_rcount,#0x00
	C$lab4Data.c$32$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:32: unsigned int heading = 2100;//actual heading, updated from compass
	mov	_heading,#0x34
	mov	(_heading + 1),#0x08
	C$lab4Data.c$33$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:33: unsigned int desired = 2100;//desired heading, set by user
	mov	_desired,#0x34
	mov	(_desired + 1),#0x08
	C$lab4Data.c$34$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:34: unsigned int rangervalue = 45;//holds ranger reading
	mov	_rangervalue,#0x2d
	mov	(_rangervalue + 1),#0x00
	C$lab4Data.c$35$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:35: unsigned int print_count = 0;//counter for printing readings
	clr	a
	mov	_print_count,a
	mov	(_print_count + 1),a
	C$lab4Data.c$38$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:38: unsigned char adc=0;//holds potentiometer data
;	1-genFromRTrack replaced	mov	_adc,#0x00
	mov	_adc,a
	C$lab4Data.c$39$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:39: unsigned char loopcontrol=0;//controls loops, used instead of break statements
;	1-genFromRTrack replaced	mov	_loopcontrol,#0x00
	mov	_loopcontrol,a
	C$lab4Data.c$42$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:42: unsigned int PW_CENTER = 2764;
	mov	_PW_CENTER,#0xcc
	mov	(_PW_CENTER + 1),#0x0a
	C$lab4Data.c$43$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:43: unsigned int PW_RIGHT = 3474;
	mov	_PW_RIGHT,#0x92
	mov	(_PW_RIGHT + 1),#0x0d
	C$lab4Data.c$44$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:44: unsigned int PW_LEFT = 2384;
	mov	_PW_LEFT,#0x50
	mov	(_PW_LEFT + 1),#0x09
	C$lab4Data.c$45$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:45: unsigned int SERVO_PW = 2764;
	mov	_SERVO_PW,#0xcc
	mov	(_SERVO_PW + 1),#0x0a
	C$lab4Data.c$46$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:46: int error=0;
	mov	_error,a
	mov	(_error + 1),a
	C$lab4Data.c$47$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:47: float k=2;//gain, set by potentiometer
	mov	_k,a
	mov	(_k + 1),a
	mov	(_k + 2),a
	mov	(_k + 3),#0x40
	C$lab4Data.c$48$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:48: unsigned int temp=0;
	mov	_temp,a
	mov	(_temp + 1),a
	C$lab4Data.c$51$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:51: unsigned int PW_MIN = 2027;      //1.1 ms  ((MAX-PCA_Start)/20) *(1.1)
	mov	_PW_MIN,#0xeb
	mov	(_PW_MIN + 1),#0x07
	C$lab4Data.c$52$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:52: unsigned int PW_MAX = 3502;      //1.9 
	mov	_PW_MAX,#0xae
	mov	(_PW_MAX + 1),#0x0d
	C$lab4Data.c$53$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:53: unsigned int PW_NEUT = 2764;
	mov	_PW_NEUT,#0xcc
	mov	(_PW_NEUT + 1),#0x0a
	C$lab4Data.c$54$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:54: unsigned int MOTOR_PW = 2764;
	mov	_MOTOR_PW,#0xcc
	mov	(_MOTOR_PW + 1),#0x0a
	C$lab4Data.c$55$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:55: unsigned char obstacle=0;
;	1-genFromRTrack replaced	mov	_obstacle,#0x00
	mov	_obstacle,a
	C$lab4Data.c$56$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:56: unsigned char stop=0;
...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$lab4Data.c$62$1$113 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:62: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$lab4Data.c$66$1$126 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:66: Sys_Init();
	lcall	_Sys_Init
	C$lab4Data.c$67$1$126 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:67: putchar(' '); //the quotes in this line may not format correctly
	mov	dpl,#0x20
	lcall	_putchar
	C$lab4Data.c$68$1$126 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:68: Port_Init();
	lcall	_Port_Init
	C$lab4Data.c$69$1$126 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:69: ADC_Init();
	lcall	_ADC_Init
	C$lab4Data.c$70$1$126 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:70: XBR0_Init();
	lcall	_XBR0_Init
	C$lab4Data.c$71$1$126 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:71: PCA_Init();
	lcall	_PCA_Init
	C$lab4Data.c$72$1$126 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:72: SMB_Init();
	lcall	_SMB_Init
	C$lab4Data.c$73$1$126 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:73: Interrupt_Init();
	lcall	_Interrupt_Init
	C$lab4Data.c$76$1$126 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:76: printf("Car control menu:\n\r");
	mov	a,#___str_3
	push	acc
	mov	a,#(___str_3 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
	C$lab4Data.c$77$1$126 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:77: printf("Choose a desired heading from the options below:\n\r");
	mov	a,#___str_4
	push	acc
	mov	a,#(___str_4 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
	C$lab4Data.c$78$2$127 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:78: while(!loopcontrol) {//loop until it gets valid input
00113$:
	mov	a,_loopcontrol
	jnz	00115$
	C$lab4Data.c$79$2$127 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:79: printf("1) 0 degrees\n\r2) 90 degrees\n\r3) 180 degrees\n\r4) 270 degrees\n\r");
	mov	a,#___str_5
	push	acc
	mov	a,#(___str_5 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
	C$lab4Data.c$80$2$127 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:80: input = getchar();
	lcall	_getchar
	mov	_input,dpl
	C$lab4Data.c$81$2$127 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:81: if(input=='1') {
	mov	a,#0x31
	cjne	a,_input,00111$
	C$lab4Data.c$82$3$128 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:82: desired=0;
	clr	a
	mov	_desired,a
	mov	(_desired + 1),a
	C$lab4Data.c$83$3$128 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:83: loopcontrol=1;
	mov	_loopcontrol,#0x01
	sjmp	00113$
00111$:
	C$lab4Data.c$85$2$127 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:85: else if(input=='2') {
	mov	a,#0x32
	cjne	a,_input,00108$
	C$lab4Data.c$86$3$129 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:86: desired=900;
	mov	_desired,#0x84
	mov	(_desired + 1),#0x03
	C$lab4Data.c$87$3$129 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:87: loopcontrol=1;
	mov	_loopcontrol,#0x01
	sjmp	00113$
00108$:
	C$lab4Data.c$89$2$127 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:89: else if(input=='3') {
	mov	a,#0x33
	cjne	a,_input,00105$
	C$lab4Data.c$90$3$130 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:90: desired=1800;
	mov	_desired,#0x08
	mov	(_desired + 1),#0x07
	C$lab4Data.c$91$3$130 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:91: loopcontrol=1;
	mov	_loopcontrol,#0x01
	sjmp	00113$
00105$:
	C$lab4Data.c$93$2$127 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:93: else if(input=='4') {
	mov	a,#0x34
	cjne	a,_input,00102$
	C$lab4Data.c$94$3$131 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:94: desired=2700;
	mov	_desired,#0x8c
	mov	(_desired + 1),#0x0a
	C$lab4Data.c$95$3$131 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:95: loopcontrol=1;
	mov	_loopcontrol,#0x01
	sjmp	00113$
00102$:
	C$lab4Data.c$98$2$127 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:98: printf("Invalid input:%u, Please enter valid input.\n\r", input);
	mov	r6,_input
	mov	r7,#0x00
	push	ar6
	push	ar7
	...
	sjmp	00113$
00115$:
	C$lab4Data.c$100$1$126 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:100: printf("Now use the potentiometer to select a steering gain.\n\r");
	mov	a,#___str_7
	push	acc
	mov	a,#(___str_7 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
	C$lab4Data.c$101$1$126 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:101: printf("Switch the slide switch when finished.\n\r");
	mov	a,#___str_8
	push	acc
	mov	a,#(___str_8 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
	C$lab4Data.c$102$1$126 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:102: temp=SS;//store value of slide switch
	mov	c,_SS
	clr	a
	rlc	a
	mov	_temp,a
	mov	(_temp + 1),#0x00
	C$lab4Data.c$103$1$126 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:103: ccount=0;//reset timer
	mov	_ccount,#0x00
	C$lab4Data.c$104$2$132 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:104: while(SS==temp) {//loops until user switches the slide switch
00119$:
	mov	c,_SS
	clr	a
	rlc	a
...
00171$:
	ljmp	00121$
00172$:
	C$lab4Data.c$105$2$132 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:105: while(ccount<40);//wait ~800ms
00116$:
	mov	a,#0x100 - 0x28
	add	a,_ccount
	jnc	00116$
	C$lab4Data.c$106$2$132 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:106: ADC_Convert();//get POT value
	lcall	_ADC_Convert
	C$lab4Data.c$107$1$126 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:107: k=(adc/255.0)*10.2;//calculate gain
	mov	dpl,_adc
	lcall	___uchar2fs
	mov	r4,dpl
	mov	r5,dph
	...
	add	a,#0xfc
	mov	sp,a
	C$lab4Data.c$108$1$126 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:108: printf("Current value*100: %d\n\r", (int)(k*100));//print gain
	push	_k
	push	(_k + 1)
	push	(_k + 2)
	push	(_k + 3)
	...
	add	a,#0xfb
	mov	sp,a
	C$lab4Data.c$109$2$132 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:109: ccount=0;//reset timer
	mov	_ccount,#0x00
	ljmp	00119$
00121$:
	C$lab4Data.c$111$1$126 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:111: printf("Final gain*100:%d\n\r", (int)(k*100));//print the final gain value
	push	_k
	push	(_k + 1)
	push	(_k + 2)
	push	(_k + 3)
	...
	add	a,#0xfb
	mov	sp,a
	C$lab4Data.c$114$1$126 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:114: SERVO_PW = PW_CENTER;
	mov	_SERVO_PW,_PW_CENTER
	mov	(_SERVO_PW + 1),(_PW_CENTER + 1)
	C$lab4Data.c$115$1$126 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:115: MOTOR_PW = PW_NEUT;
	mov	_MOTOR_PW,_PW_NEUT
	mov	(_MOTOR_PW + 1),(_PW_NEUT + 1)
	C$lab4Data.c$116$1$126 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:116: lcd_clear();
	lcall	_lcd_clear
	C$lab4Data.c$117$1$126 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:117: ccount=0;
	mov	_ccount,#0x00
	C$lab4Data.c$118$1$126 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:118: rcount=0;
	mov	_rcount,#0x00
	C$lab4Data.c$119$1$126 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:119: while(1) {
00125$:
	C$lab4Data.c$120$2$133 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:120: Steering_Servo();//Servo control with compass
	lcall	_Steering_Servo
	C$lab4Data.c$121$2$133 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:121: Ranger();//Motor control with ranger
	lcall	_Ranger
	C$lab4Data.c$122$2$133 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:122: if(print_count>=25) {//print data every 1 seconds
	clr	c
	mov	a,_print_count
	subb	a,#0x19
	...
	subb	a,#0x00
	jc	00125$
	C$lab4Data.c$123$3$134 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:123: lcd_clear();
	lcall	_lcd_clear
	C$lab4Data.c$124$3$134 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:124: lcd_print("Heading: %u\nRanger Value: %u", heading, rangervalue);
	push	_rangervalue
	push	(_rangervalue + 1)
	push	_heading
	push	(_heading + 1)
...
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:125: printf("\n\rHeading: %u\t\tRanger Value: %u\tdPW: %d\n\r", heading, rangervalue, SERVO_PW-PW_CENTER);
	...
	add	a,#0xf7
	mov	sp,a
	C$lab4Data.c$126$3$134 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:126: print_count=0;
	clr	a
	mov	_print_count,a
	mov	(_print_count + 1),a
	sjmp	00125$
	C$lab4Data.c$129$1$126 ==.
	XG$main$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$Port_Init$0$0 ==.
	C$lab4Data.c$136$1$126 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:136: void Port_Init()
;	-----------------------------------------
;	 function Port_Init
;	-----------------------------------------
_Port_Init:
	C$lab4Data.c$138$1$135 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:138: P1MDOUT = 0x05;//set output pin for CEX0,2 in push-pull mode
	mov	_P1MDOUT,#0x05
	C$lab4Data.c$139$1$135 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:139: P1 |= 0x80;	   //also set pin for POT in open-drain mode
	orl	_P1,#0x80
	C$lab4Data.c$140$1$135 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:140: P3MDOUT &= ~0x80;//set pin for slide switch in open-drain mode
	anl	_P3MDOUT,#0x7f
	C$lab4Data.c$141$1$135 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:141: P3 |=0x80;
	orl	_P3,#0x80
	C$lab4Data.c$142$1$135 ==.
	XG$Port_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$XBR0_Init$0$0 ==.
	C$lab4Data.c$149$1$135 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:149: void XBR0_Init()
;	-----------------------------------------
;	 function XBR0_Init
;	-----------------------------------------
_XBR0_Init:
	C$lab4Data.c$151$1$136 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:151: XBR0 = 0x1F; //configure crossbar with UART, SPI, SMBus, and CEX channels 0,1,2
	mov	_XBR0,#0x1f
	C$lab4Data.c$152$1$136 ==.
	XG$XBR0_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$SMB_Init$0$0 ==.
	C$lab4Data.c$154$1$136 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:154: void SMB_Init(void) {//Set up i2c
;	-----------------------------------------
;	 function SMB_Init
;	-----------------------------------------
_SMB_Init:
	C$lab4Data.c$155$1$138 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:155: SMB0CR = 0x93; //run at 100kHZ
	mov	_SMB0CR,#0x93
	C$lab4Data.c$156$1$138 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:156: ENSMB = 1; //enable smbus
	setb	_ENSMB
	C$lab4Data.c$157$1$138 ==.
	XG$SMB_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$ADC_Init$0$0 ==.
	C$lab4Data.c$159$1$138 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:159: void ADC_Init(void) {		//initialize ADC
;	-----------------------------------------
;	 function ADC_Init
;	-----------------------------------------
_ADC_Init:
	C$lab4Data.c$160$1$140 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:160: REF0CN = 0x03; 			//set Vref to use 2.4V
	mov	_REF0CN,#0x03
	C$lab4Data.c$161$1$140 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:161: ADC1CF |= 0x01;			//set gain of 1
	orl	_ADC1CF,#0x01
	C$lab4Data.c$162$1$140 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:162: ADC1CN = 0x80; 			//enable A/D converter
	mov	_ADC1CN,#0x80
	C$lab4Data.c$164$1$140 ==.
	XG$ADC_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$ADC_Convert$0$0 ==.
	C$lab4Data.c$166$1$140 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:166: void ADC_Convert(void) {	//get POT value
;	-----------------------------------------
;	 function ADC_Convert
;	-----------------------------------------
_ADC_Convert:
	C$lab4Data.c$167$1$142 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:167: AMX1SL = 7;				//Set ADC to convert value on pin 7
	mov	_AMX1SL,#0x07
	C$lab4Data.c$168$1$142 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:168: ADC1CN &= ~0x20;//clear flag		
	anl	_ADC1CN,#0xdf
	C$lab4Data.c$169$1$142 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:169: ADC1CN |= 0x10;//start conversion
	orl	_ADC1CN,#0x10
	C$lab4Data.c$170$1$142 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:170: while((ADC1CN & 0x20)==0x00);//wait for conversion to finish
00101$:
	mov	a,_ADC1CN
	jnb	acc.5,00101$
	C$lab4Data.c$171$1$142 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:171: adc = ADC1;//store adc value
	mov	_adc,_ADC1
	C$lab4Data.c$172$1$142 ==.
	XG$ADC_Convert$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$PCA_Init$0$0 ==.
	C$lab4Data.c$174$1$142 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:174: void PCA_Init(void)
;	-----------------------------------------
;	 function PCA_Init
;	-----------------------------------------
_PCA_Init:
	C$lab4Data.c$176$1$144 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:176: PCA0MD = 0x81; //SYSCLK/12, enable CF interrupts, suspend when idle
	mov	_PCA0MD,#0x81
	C$lab4Data.c$177$1$144 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:177: PCA0CPM0 = 0xC2; //16 bit, enable compare, enable PWM
	mov	_PCA0CPM0,#0xc2
	C$lab4Data.c$178$1$144 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:178: PCA0CPM2 = 0xC2; //set up CEX2 the same as CEX0
	mov	_PCA0CPM2,#0xc2
	C$lab4Data.c$179$1$144 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:179: PCA0CN |= 0x40; // enable PCA
	orl	_PCA0CN,#0x40
	C$lab4Data.c$180$1$144 ==.
	XG$PCA_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	...
	C$lab4Data.c$182$1$144 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:182: void Interrupt_Init(void)
;	-----------------------------------------
;	 function Interrupt_Init
;	-----------------------------------------
_Interrupt_Init:
	C$lab4Data.c$184$1$146 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:184: EIE1 |= 0x08;//enable PCA interrupts
	orl	_EIE1,#0x08
	C$lab4Data.c$186$1$146 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:186: EA=1;//enable all interrupts
	setb	_EA
	C$lab4Data.c$187$1$146 ==.
...
;------------------------------------------------------------
	G$PCA_ISR$0$0 ==.
	C$lab4Data.c$189$1$146 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:189: void PCA_ISR ( void ) __interrupt 9
;	-----------------------------------------
;	 function PCA_ISR
;	-----------------------------------------
_PCA_ISR:
	C$lab4Data.c$191$1$148 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:191: if(CF) {
	jnb	_CF,00102$
	C$lab4Data.c$192$2$149 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:192: PCA0 = PCA_start;//Start count
	mov	((_PCA0 >> 0) & 0xFF),_PCA_start
	mov	((_PCA0 >> 8) & 0xFF),(_PCA_start + 1)
	C$lab4Data.c$193$2$149 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:193: CF=0;//clear interrupt flag
	clr	_CF
	C$lab4Data.c$194$2$149 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:194: ccount++;//increment compass counter
	inc	_ccount
	C$lab4Data.c$195$2$149 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:195: rcount++;//increment ranger counter
	inc	_rcount
	sjmp	00104$
00102$:
	C$lab4Data.c$197$1$148 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:197: else PCA0CN &= 0xC0;//all other type 9 interrupts
	anl	_PCA0CN,#0xc0
00104$:
	C$lab4Data.c$198$1$148 ==.
	XG$PCA_ISR$0$0 ==.
	reti
...
;------------------------------------------------------------
	G$Read_Compass$0$0 ==.
	C$lab4Data.c$200$1$148 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:200: void Read_Compass(void) {
;	-----------------------------------------
;	 function Read_Compass
;	-----------------------------------------
_Read_Compass:
	C$lab4Data.c$201$1$151 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:201: i2c_read_data(0xC0, 2, Data, 2);//read two bytes starting at reg. 2
	...
	mov	dpl,#0xc0
	lcall	_i2c_read_data
	C$lab4Data.c$202$1$151 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:202: heading = (((unsigned int)Data[0]<<8) | Data[1]);//combine data
	mov	r7,_Data
	mov	r6,#0x00
	mov	r4,(_Data + 0x0001)
	mov	r5,#0x00
...
;------------------------------------------------------------
	G$ReadRanger$0$0 ==.
	C$lab4Data.c$205$1$151 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:205: unsigned int ReadRanger()
;	-----------------------------------------
;	 function ReadRanger
;	-----------------------------------------
_ReadRanger:
	C$lab4Data.c$209$1$152 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:209: i2c_read_data(addr,2, Data, 2);    // read two bytes, starting at reg 2 
	mov	_i2c_read_data_PARM_3,#_Data
	mov	(_i2c_read_data_PARM_3 + 1),#0x00
	mov	(_i2c_read_data_PARM_3 + 2),#0x40
	mov	_i2c_read_data_PARM_2,#0x02
	...
	mov	dpl,#0xe0
	lcall	_i2c_read_data
	C$lab4Data.c$210$1$152 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:210: range = (((unsigned int)Data[0] << 8) | Data[1]);    //value read from i2c 
	mov	r7,_Data
	mov	r6,#0x00
	mov	r4,(_Data + 0x0001)
	mov	r5,#0x00
	...
	orl	a,r7
	mov	dph,a
	C$lab4Data.c$211$1$152 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:211: return range;
	C$lab4Data.c$212$1$152 ==.
	XG$ReadRanger$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$Ranger$0$0 ==.
	C$lab4Data.c$214$1$152 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:214: void Ranger(void)//function to control the motor with the ranger
;	-----------------------------------------
;	 function Ranger
;	-----------------------------------------
_Ranger:
	C$lab4Data.c$219$1$154 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:219: if(rcount>=4) {
	mov	a,#0x100 - 0x04
	add	a,_rcount
	jnc	00102$
	C$lab4Data.c$220$2$155 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:220: rangervalue = ReadRanger();//get ranger value
	lcall	_ReadRanger
	mov	_rangervalue,dpl
	mov	(_rangervalue + 1),dph
	C$lab4Data.c$221$2$155 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:221: Data[0] = 0x51;                //sets results in cm
	mov	_Data,#0x51
	C$lab4Data.c$222$2$155 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:222: i2c_write_data(0xE0,0,Data,1);    //Write one byte of data to reg 0 at addr			
	...
	mov	dpl,#0xe0
	lcall	_i2c_write_data
	C$lab4Data.c$223$2$155 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:223: rcount=0;
	mov	_rcount,#0x00
00102$:
	C$lab4Data.c$226$1$154 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:226: if(rangervalue<30 && !SS && !stop) {//if it detects an obstacle and program is running
	clr	c
	mov	a,_rangervalue
	subb	a,#0x1e
...
00171$:
	...
	ljmp	00121$
00172$:
	C$lab4Data.c$227$2$156 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:227: if(obstacle>=1) {//if this is the second obstacle
	mov	a,#0x100 - 0x01
	add	a,_obstacle
	jnc	00118$
	C$lab4Data.c$228$3$157 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:228: printf("Second obstacle found\n\r");
	mov	a,#___str_13
	push	acc
	mov	a,#(___str_13 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
	C$lab4Data.c$229$3$157 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:229: stop=1;//stop the car
	mov	_stop,#0x01
	ljmp	00121$
00118$:
	C$lab4Data.c$232$3$158 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:232: temp=MOTOR_PW;//store pulsewidth
	mov	_temp,_MOTOR_PW
	mov	(_temp + 1),(_MOTOR_PW + 1)
	C$lab4Data.c$233$3$158 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:233: MOTOR_PW=PW_NEUT;//stop car
	mov	_MOTOR_PW,_PW_NEUT
	mov	(_MOTOR_PW + 1),(_PW_NEUT + 1)
	C$lab4Data.c$234$3$158 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:234: PCA0CP2 = 0xFFFF - MOTOR_PW;
	mov	a,#0xff
	clr	c
	subb	a,_MOTOR_PW
	...
	C$lab4Data.c$235$3$158 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:235: obstacle++;
	inc	_obstacle
	C$lab4Data.c$236$3$158 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:236: printf("Obstacle detected. Press 'r' or 'l' to steer around obstacle.");
	mov	a,#___str_14
	push	acc
	mov	a,#(___str_14 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
	C$lab4Data.c$237$3$158 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:237: input=getchar();//print instructions and get user input
	lcall	_getchar
	mov	_input,dpl
	C$lab4Data.c$238$3$158 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:238: loopcontrol=0;
	mov	_loopcontrol,#0x00
	C$lab4Data.c$239$5$162 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:239: while(!loopcontrol) {//wait until it gets valid input
00111$:
	mov	a,_loopcontrol
	jnz	00113$
	C$lab4Data.c$240$4$159 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:240: if(input=='l' || input=='L') {//set steering to all the way left
	mov	a,#0x6c
	cjne	a,_input,00175$
	sjmp	00107$
00175$:
	...
	cjne	a,_input,00108$
00107$:
	C$lab4Data.c$241$5$160 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:241: SERVO_PW = PW_LEFT;
	mov	_SERVO_PW,_PW_LEFT
	mov	(_SERVO_PW + 1),(_PW_LEFT + 1)
	C$lab4Data.c$242$5$160 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:242: loopcontrol=1;
	mov	_loopcontrol,#0x01
	sjmp	00111$
00108$:
	C$lab4Data.c$244$4$159 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:244: else if(input=='r' || input=='R') {//set steering to max right
	mov	a,#0x72
	cjne	a,_input,00178$
	sjmp	00103$
00178$:
	...
	cjne	a,_input,00104$
00103$:
	C$lab4Data.c$245$5$161 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:245: SERVO_PW = PW_RIGHT;
	mov	_SERVO_PW,_PW_RIGHT
	mov	(_SERVO_PW + 1),(_PW_RIGHT + 1)
	C$lab4Data.c$246$5$161 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:246: loopcontrol=1;
	mov	_loopcontrol,#0x01
	sjmp	00111$
00104$:
	C$lab4Data.c$249$5$162 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:249: printf("Invalid input. Please enter 'l' or 'r'.\n\r");
	mov	a,#___str_15
	push	acc
	mov	a,#(___str_15 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
	C$lab4Data.c$250$5$162 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:250: input=getchar();
	lcall	_getchar
	mov	_input,dpl
	sjmp	00111$
00113$:
	C$lab4Data.c$253$3$158 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:253: PCA0CP0 = 0xFFFF - SERVO_PW;
	mov	a,#0xff
	clr	c
	subb	a,_SERVO_PW
	...
	C$lab4Data.c$254$3$158 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:254: printf("\n\rPress space when the car is around the obstacle\n\r");
	mov	a,#___str_16
	push	acc
	mov	a,#(___str_16 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
	C$lab4Data.c$255$3$158 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:255: MOTOR_PW = temp;
	mov	_MOTOR_PW,_temp
	mov	(_MOTOR_PW + 1),(_temp + 1)
	C$lab4Data.c$256$3$158 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:256: PCA0CP2 = 0xFFFF - MOTOR_PW;
	mov	a,#0xff
	clr	c
	subb	a,_MOTOR_PW
	mov	((_PCA0CP2 >> 0) & 0xFF),a
	...
	subb	a,(_MOTOR_PW + 1)
	mov	((_PCA0CP2 >> 8) & 0xFF),a
	C$lab4Data.c$258$3$158 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:258: getchar();//run in that direction until user presses a character
	lcall	_getchar
	C$lab4Data.c$260$3$158 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:260: Data[0] = 0x51;                //write 0x51 to reg 0 of the ranger, sets results in cm
	mov	_Data,#0x51
	C$lab4Data.c$261$3$158 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:261: i2c_write_data(0xE0,0,Data,1);    //Write one byte of data to reg 0 at addr
	mov	_i2c_write_data_PARM_3,#_Data
	mov	(_i2c_write_data_PARM_3 + 1),#0x00
	mov	(_i2c_write_data_PARM_3 + 2),#0x40
	mov	_i2c_write_data_PARM_2,#0x00
	...
	mov	dpl,#0xe0
	lcall	_i2c_write_data
	C$lab4Data.c$262$3$158 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:262: rcount=0;
	mov	_rcount,#0x00
	C$lab4Data.c$263$3$158 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:263: while(rcount<4);
00114$:
	mov	a,#0x100 - 0x04
	add	a,_rcount
	jnc	00114$
	C$lab4Data.c$264$3$158 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:264: rangervalue=ReadRanger();//make a read from the ranger that does nothing
	lcall	_ReadRanger
	mov	_rangervalue,dpl
	mov	(_rangervalue + 1),dph
	C$lab4Data.c$266$3$158 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:266: rcount=0;
	mov	_rcount,#0x00
00121$:
	C$lab4Data.c$270$1$154 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:270: if(!SS && !stop) {//if program is running
	jb	_SS,00125$
	mov	a,_stop
	jnz	00125$
	C$lab4Data.c$273$2$163 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:273: MOTOR_PW = PW_MAX-250;
	mov	a,_PW_MAX
	add	a,#0x06
	mov	_MOTOR_PW,a
	mov	a,(_PW_MAX + 1)
	...
	sjmp	00126$
00125$:
	C$lab4Data.c$277$1$154 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:277: MOTOR_PW = PW_NEUT;//motor is stopped
	mov	_MOTOR_PW,_PW_NEUT
	mov	(_MOTOR_PW + 1),(_PW_NEUT + 1)
00126$:
	C$lab4Data.c$279$1$154 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:279: PCA0CP2 = 0xFFFF - MOTOR_PW;
	mov	a,#0xff
	clr	c
	subb	a,_MOTOR_PW
	mov	((_PCA0CP2 >> 0) & 0xFF),a
...
;------------------------------------------------------------
	...
	C$lab4Data.c$283$1$154 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:283: void Steering_Servo()//function to control the steering with the compass
;	-----------------------------------------
;	 function Steering_Servo
;	-----------------------------------------
_Steering_Servo:
	C$lab4Data.c$286$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:286: if(ccount>=2) {//every 40ms read the compass
	mov	a,#0x100 - 0x02
	add	a,_ccount
	jnc	00102$
	C$lab4Data.c$287$2$165 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:287: print_count++;
	inc	_print_count
	clr	a
	cjne	a,_print_count,00142$
	inc	(_print_count + 1)
00142$:
	C$lab4Data.c$288$2$165 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:288: Read_Compass();
	lcall	_Read_Compass
	C$lab4Data.c$289$2$165 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:289: ccount=0;
	mov	_ccount,#0x00
00102$:
	C$lab4Data.c$292$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:292: error=desired-heading;//calculate error
	mov	a,_desired
	clr	c
	subb	a,_heading
	mov	_error,a
	...
	subb	a,(_heading + 1)
	mov	(_error + 1),a
	C$lab4Data.c$293$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:293: if(error>1800)//adjust error if out of bounds
	clr	c
	mov	a,#0x08
	subb	a,_error
	mov	a,#(0x07 ^ 0x80)
	...
	subb	a,b
	jnc	00106$
	C$lab4Data.c$294$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:294: error-=3600;
	mov	a,_error
	add	a,#0xf0
	mov	_error,a
	mov	a,(_error + 1)
	...
	sjmp	00107$
00106$:
	C$lab4Data.c$295$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:295: else if(error<-1800)
	clr	c
	mov	a,_error
	subb	a,#0xf8
	mov	a,(_error + 1)
	...
	subb	a,#0x78
	jnc	00107$
	C$lab4Data.c$296$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:296: error+=3600;
	mov	a,#0x10
	add	a,_error
	mov	_error,a
	mov	a,#0x0e
	...
	mov	(_error + 1),a
00107$:
	C$lab4Data.c$298$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:298: temp = (float)error*k+PW_CENTER;//calculate pulsewidth
	mov	dpl,_error
	mov	dph,(_error + 1)
	lcall	___sint2fs
	mov	r4,dpl
	...
	mov	_temp,dpl
	mov	(_temp + 1),dph
	C$lab4Data.c$299$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:299: if(!SS && !stop) {//if program is running
	jb	_SS,00115$
	mov	a,_stop
	jnz	00115$
	C$lab4Data.c$300$2$166 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:300: if(temp>PW_RIGHT)//adjust pulsewidth if out of bounds
	clr	c
	mov	a,_PW_RIGHT
	subb	a,_temp
	mov	a,(_PW_RIGHT + 1)
	subb	a,(_temp + 1)
	jnc	00112$
	C$lab4Data.c$301$2$166 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:301: SERVO_PW=PW_RIGHT;
	mov	_SERVO_PW,_PW_RIGHT
	mov	(_SERVO_PW + 1),(_PW_RIGHT + 1)
	sjmp	00116$
00112$:
	C$lab4Data.c$302$2$166 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:302: else if(temp<PW_LEFT)
	clr	c
	mov	a,_temp
	subb	a,_PW_LEFT
	mov	a,(_temp + 1)
	subb	a,(_PW_LEFT + 1)
	jnc	00109$
	C$lab4Data.c$303$2$166 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:303: SERVO_PW=PW_LEFT;
	mov	_SERVO_PW,_PW_LEFT
	mov	(_SERVO_PW + 1),(_PW_LEFT + 1)
	sjmp	00116$
00109$:
	C$lab4Data.c$305$2$166 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:305: SERVO_PW=temp;
	mov	_SERVO_PW,_temp
	mov	(_SERVO_PW + 1),(_temp + 1)
	sjmp	00116$
00115$:
	C$lab4Data.c$308$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:308: SERVO_PW=PW_CENTER;
	mov	_SERVO_PW,_PW_CENTER
	mov	(_SERVO_PW + 1),(_PW_CENTER + 1)
00116$:
	C$lab4Data.c$310$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:310: PCA0CPL0 = 0xFFFF - SERVO_PW;//set servo
	mov	r7,_SERVO_PW
	mov	a,#0xff
	clr	c
	subb	a,r7
	mov	_PCA0CPL0,a
	C$lab4Data.c$311$1$164 ==.
;	C:\SiLabs\LITEC\Lab4\lab4Data.c:311: PCA0CPH0 = (0xFFFF - SERVO_PW) >> 8;
	mov	a,#0xff
	clr	c
	subb	a,_SERVO_PW
	mov	a,#0xff
	...
	mov	r7,a
	mov	_PCA0CPH0,r7
	C$lab4Data.c$312$1$164 ==.
	XG$Steering_Servo$0$0 ==.
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
Flab4Data$__str_0$0$0 == .
___str_0:
	.db 0x0a
	.ascii "Type digits; end w/#"
	.db 0x00
Flab4Data$__str_1$0$0 == .
___str_1:
	.ascii "     %c%c%c%c%c"
	.db 0x00
Flab4Data$__str_2$0$0 == .
___str_2:
	.ascii "%c"
	.db 0x00
Flab4Data$__str_3$0$0 == .
___str_3:
	.ascii "Car control menu:"
	.db 0x0a
	.db 0x0d
	.db 0x00
Flab4Data$__str_4$0$0 == .
___str_4:
	.ascii "Choose a desired heading from the options below:"
	.db 0x0a
	.db 0x0d
	.db 0x00
Flab4Data$__str_5$0$0 == .
___str_5:
	.ascii "1) 0 degrees"
	.db 0x0a
	.db 0x0d

...
S:Llab4.lcd_print$fmt$1$80({3}DG,SC:U),B,1,-5
S:Llab4.lcd_print$len$1$81({1}SC:U),R,0,0,[r6]
S:Llab4.lcd_print$i$1$81({1}SC:U),R,0,0,[]
S:Llab4.lcd_print$ap$1$81({1}DD,SC:U),R,0,0,[]
...
S:Llab4.getchar$c$1$10({1}SC:U),R,0,0,[]
S:Llab4.getchar_nw$c$1$12({1}SC:U),R,0,0,[]
S:G$Data2$0$0({3}DA3d,SC:U),E,0,0
S:Llab4.aligned_alloc$size$1$39({2}SI:U),E,0,0
S:Llab4.aligned_alloc$alignment$1$39({2}SI:U),E,0,0
S:Llab4.lcd_clear$NumBytes$1$85({1}SC:U),E,0,0
S:Llab4.lcd_clear$Cmd$1$85({2}DA2d,SC:U),E,0,0
S:Llab4.read_keypad$i$1$86({1}SC:U),R,0,0,[r7]
S:Llab4.read_keypad$Data$1$86({2}DA2d,SC:U),E,0,0
S:Llab4.kpd_input$mode$1$88({1}SC:U),R,0,0,[r7]
S:Llab4.kpd_input$sum$1$89({2}SI:U),R,0,0,[r5,r6]
S:Llab4.kpd_input$key$1$89({1}SC:U),R,0,0,[r3]
S:Llab4.kpd_input$i$1$89({1}SC:U),R,0,0,[]
S:Llab4.i2c_write_data$start_reg$1$105({1}SC:U),E,0,0
S:Llab4.i2c_write_data$buffer$1$105({3}DG,SC:U),E,0,0
S:Llab4.i2c_write_data$num_bytes$1$105({1}SC:U),E,0,0
S:Llab4.i2c_write_data$addr$1$105({1}SC:U),R,0,0,[r7]
S:Llab4.i2c_write_data$i$1$106({1}SC:U),R,0,0,[]
S:Llab4.i2c_read_data$start_reg$1$107({1}SC:U),E,0,0
S:Llab4.i2c_read_data$buffer$1$107({3}DG,SC:U),E,0,0
S:Llab4.i2c_read_data$num_bytes$1$107({1}SC:U),E,0,0
S:Llab4.i2c_read_data$addr$1$107({1}SC:U),R,0,0,[r7]
S:Llab4.i2c_read_data$j$1$108({1}SC:U),R,0,0,[]
...
S:Llab4.ReadRanger$range$1$152({2}SI:U),R,0,0,[]
S:Llab4.ReadRanger$addr$1$152({1}SC:U),R,0,0,[]
S:Llab4.lcd_print$text$1$81({80}DA80d,SC:U),F,0,0
...
S:Flab4$__str_3$0$0({20}DA20d,SC:S),D,0,0
S:Flab4$__str_4$0$0({51}DA51d,SC:S),D,0,0
S:Flab4$__str_5$0$0({62}DA62d,SC:S),D,0,0
S:Flab4$__str_6$0$0({46}DA46d,SC:S),D,0,0
S:Flab4$__str_7$0$0({55}DA55d,SC:S),D,0,0
S:Flab4$__str_8$0$0({41}DA41d,SC:S),D,0,0
S:Flab4$__str_9$0$0({24}DA24d,SC:S),D,0,0
S:Flab4$__str_10$0$0({20}DA20d,SC:S),D,0,0
S:Flab4$__str_11$0$0({29}DA29d,SC:S),D,0,0
S:Flab4$__str_12$0$0({34}DA34d,SC:S),D,0,0
S:Flab4$__str_13$0$0({24}DA24d,SC:S),D,0,0
S:Flab4$__str_14$0$0({62}DA62d,SC:S),D,0,0
S:Flab4$__str_15$0$0({42}DA42d,SC:S),D,0,0
S:Flab4$__str_16$0$0({52}DA52d,SC:S),D,0,0

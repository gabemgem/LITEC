...
_Data2::
	.ds 3
Ltester.aligned_alloc$size$1$39==.
_aligned_alloc_PARM_2:
	.ds 2
Ltester.lcd_clear$NumBytes$1$85==.
_lcd_clear_NumBytes_1_85:
	.ds 1
Ltester.lcd_clear$Cmd$1$85==.
_lcd_clear_Cmd_1_85:
	.ds 2
Ltester.read_keypad$Data$1$86==.
_read_keypad_Data_1_86:
	.ds 2
Ltester.i2c_write_data$start_reg$1$105==.
_i2c_write_data_PARM_2:
	.ds 1
Ltester.i2c_write_data$buffer$1$105==.
_i2c_write_data_PARM_3:
	.ds 3
Ltester.i2c_write_data$num_bytes$1$105==.
_i2c_write_data_PARM_4:
	.ds 1
Ltester.i2c_read_data$start_reg$1$107==.
_i2c_read_data_PARM_2:
	.ds 1
Ltester.i2c_read_data$buffer$1$107==.
_i2c_read_data_PARM_3:
	.ds 3
Ltester.i2c_read_data$num_bytes$1$107==.
...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$tester.c$24$1$113 ==.
;	C:\SiLabs\LITEC\Lab5\tester.c:24: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$tester.c$26$1$116 ==.
;	C:\SiLabs\LITEC\Lab5\tester.c:26: Sys_Init();
	lcall	_Sys_Init
	C$tester.c$27$1$116 ==.
;	C:\SiLabs\LITEC\Lab5\tester.c:27: putchar(' ');
	mov	dpl,#0x20
	lcall	_putchar
	C$tester.c$28$1$116 ==.
;	C:\SiLabs\LITEC\Lab5\tester.c:28: Port_Init();
	lcall	_Port_Init
	C$tester.c$30$1$116 ==.
;	C:\SiLabs\LITEC\Lab5\tester.c:30: while(1) {
00105$:
	C$tester.c$31$2$117 ==.
;	C:\SiLabs\LITEC\Lab5\tester.c:31: if(SS)
	jnb	_SS,00102$
	C$tester.c$32$2$117 ==.
;	C:\SiLabs\LITEC\Lab5\tester.c:32: BUZZ=1;
	setb	_BUZZ
	sjmp	00105$
00102$:
	C$tester.c$34$2$117 ==.
;	C:\SiLabs\LITEC\Lab5\tester.c:34: BUZZ=0;
	clr	_BUZZ
	sjmp	00105$
	C$tester.c$36$1$116 ==.
	XG$main$0$0 ==.
...
;------------------------------------------------------------
	G$Port_Init$0$0 ==.
	C$tester.c$38$1$116 ==.
;	C:\SiLabs\LITEC\Lab5\tester.c:38: void Port_Init()
;	-----------------------------------------
;	 function Port_Init
;	-----------------------------------------
_Port_Init:
	C$tester.c$40$1$118 ==.
;	C:\SiLabs\LITEC\Lab5\tester.c:40: P1MDOUT = 0x05;//set output pin for CEX0,2 in push-pull mode
	mov	_P1MDOUT,#0x05
	C$tester.c$41$1$118 ==.
;	C:\SiLabs\LITEC\Lab5\tester.c:41: P1 |= 0x80;	   //also set pin for POT in high impedance mode
	orl	_P1,#0x80
	C$tester.c$42$1$118 ==.
;	C:\SiLabs\LITEC\Lab5\tester.c:42: P3MDOUT = 0x10;//set pin for slide switch in open-drain mode
	mov	_P3MDOUT,#0x10
	C$tester.c$43$1$118 ==.
;	C:\SiLabs\LITEC\Lab5\tester.c:43: P3 |=0x08;
	orl	_P3,#0x08
	C$tester.c$44$1$118 ==.
	XG$Port_Init$0$0 ==.
	ret

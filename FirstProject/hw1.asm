...
;------------------------------------------------------------
;imax                      Allocated to registers r4 r5 
...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$hw1.c$6$1$12 ==.
;	C:\SiLabs\LITEC\FirstProject\hw1.c:6: void main(void)    /* start main function */
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$hw1.c$13$1$28 ==.
;	C:\SiLabs\LITEC\FirstProject\hw1.c:13: Sys_Init();    /* Initialize UART, System clock and crossbar*/
	lcall	_Sys_Init
	C$hw1.c$14$1$28 ==.
;	C:\SiLabs\LITEC\FirstProject\hw1.c:14: putchar(' ');  /* do this because we tell you to */
	mov	dpl,#0x20
	lcall	_putchar
	C$hw1.c$15$1$28 ==.
;	C:\SiLabs\LITEC\FirstProject\hw1.c:15: while(1)       /* begin infinite loop */
00109$:
	C$hw1.c$17$2$29 ==.
;	C:\SiLabs\LITEC\FirstProject\hw1.c:17: printf("\r\n enter 1 to count to 18 or 2 to count to 270 \r\n");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
	C$hw1.c$18$2$29 ==.
;	C:\SiLabs\LITEC\FirstProject\hw1.c:18: input=getchar();       /* get count value */
	lcall	_getchar
	mov	r6,dpl
	mov	r7,#0x00
	C$hw1.c$19$2$29 ==.
;	C:\SiLabs\LITEC\FirstProject\hw1.c:19: if (input=='1')        /* if input is 1, count to 18 */
	cjne	r6,#0x31,00105$
	cjne	r7,#0x00,00105$
	C$hw1.c$22$3$30 ==.
;	C:\SiLabs\LITEC\FirstProject\hw1.c:22: imax=18;
	mov	r4,#0x12
	mov	r5,#0x00
	sjmp	00106$
00105$:
	C$hw1.c$24$2$29 ==.
;	C:\SiLabs\LITEC\FirstProject\hw1.c:24: else if (input=='2')   /* if input is 2, count to 270 */
	cjne	r6,#0x32,00102$
	cjne	r7,#0x00,00102$
	C$hw1.c$27$3$31 ==.
;	C:\SiLabs\LITEC\FirstProject\hw1.c:27: imax=270;
	mov	r4,#0x0e
	mov	r5,#0x01
	sjmp	00106$
00102$:
	C$hw1.c$29$2$29 ==.
;	C:\SiLabs\LITEC\FirstProject\hw1.c:29: else imax=0;           /* for other inputs, skip counting */
	mov	r4,#0x00
	mov	r5,#0x00
00106$:
	C$hw1.c$30$2$29 ==.
;	C:\SiLabs\LITEC\FirstProject\hw1.c:30: printf("\n count value is %u  ",imax);
	push	ar5
	push	ar4
	push	ar4
	push	ar5
	...
	mov	sp,a
	C$hw1.c$31$2$29 ==.
;	C:\SiLabs\LITEC\FirstProject\hw1.c:31: printf("\n\n Decimal   hex \n\r");
	mov	a,#___str_2
	push	acc
	mov	a,#(___str_2 >> 8)
	push	acc
	...
	pop	ar5
	C$hw1.c$32$2$29 ==.
;	C:\SiLabs\LITEC\FirstProject\hw1.c:32: for(i=0;i<=imax;i++)
	mov	r6,#0x00
	mov	r7,#0x00
00112$:
	clr	c
...
00135$:
	C$hw1.c$35$3$32 ==.
;	C:\SiLabs\LITEC\FirstProject\hw1.c:35: printf("%u   %x \n\r", count, count); 
	push	ar7
	push	ar6
	push	ar5
	push	ar4

...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$hw2.c$34$1$12 ==.
;	C:\SiLabs\LITEC\Homework2\hw2.c:34: void main(void) 	       			// Start main function
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$hw2.c$37$1$30 ==.
;	C:\SiLabs\LITEC\Homework2\hw2.c:37: Sys_Init();   					// Initialize UART, System clock and crossbar
	lcall	_Sys_Init
	C$hw2.c$38$1$30 ==.
;	C:\SiLabs\LITEC\Homework2\hw2.c:38: putchar(' '); 					// Do this because we tell you to 
	mov	dpl,#0x20
	lcall	_putchar
	C$hw2.c$39$1$30 ==.
;	C:\SiLabs\LITEC\Homework2\hw2.c:39: printf("LITEC Homework Assignment 2\r\n\n"); // Print start message
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
	C$hw2.c$42$1$30 ==.
;	C:\SiLabs\LITEC\Homework2\hw2.c:42: while(1)      					// Begin infinite loop 
00107$:
	C$hw2.c$44$2$31 ==.
;	C:\SiLabs\LITEC\Homework2\hw2.c:44: printf("Enter a one digit number greater than 5 \r\n");
	mov	a,#___str_1
	push	acc
	mov	a,#(___str_1 >> 8)
	push	acc
	...
	dec	sp
	C$hw2.c$45$2$31 ==.
;	C:\SiLabs\LITEC\Homework2\hw2.c:45: input = getchar();      		// Get keyboard input
	lcall	_getchar
	C$hw2.c$46$2$31 ==.
;	C:\SiLabs\LITEC\Homework2\hw2.c:46: number = input-48;			// this line is not a mistake
	mov	a,dpl
	mov	_input,a
	add	a,#0xd0
	C$hw2.c$49$2$31 ==.
;	C:\SiLabs\LITEC\Homework2\hw2.c:49: if (number <= 5)				// the 5 is not a mistake
	mov  _number,a
	add	a,#0xff - 0x05
	jc	00104$
	C$hw2.c$51$3$32 ==.
;	C:\SiLabs\LITEC\Homework2\hw2.c:51: Wrong();
	lcall	_Wrong
	sjmp	00105$
00104$:
	C$hw2.c$53$2$31 ==.
;	C:\SiLabs\LITEC\Homework2\hw2.c:53: else if (number > 5)		// the 5 is not a mistake
	mov	a,_number
	add	a,#0xff - 0x05
	jnc	00105$
	C$hw2.c$55$3$33 ==.
;	C:\SiLabs\LITEC\Homework2\hw2.c:55: Right();
	lcall	_Right
00105$:
	C$hw2.c$58$2$31 ==.
;	C:\SiLabs\LITEC\Homework2\hw2.c:58: printf("Press any key to try again \r\n");
	mov	a,#___str_2
	push	acc
	mov	a,#(___str_2 >> 8)
	push	acc
	...
	dec	sp
	C$hw2.c$59$2$31 ==.
;	C:\SiLabs\LITEC\Homework2\hw2.c:59: getchar();
	lcall	_getchar
	sjmp	00107$
	C$hw2.c$61$1$30 ==.
	XG$main$0$0 ==.
...
;------------------------------------------------------------
	G$Right$0$0 ==.
	C$hw2.c$66$1$30 ==.
;	C:\SiLabs\LITEC\Homework2\hw2.c:66: void Right(void)
;	-----------------------------------------
;	 function Right
;	-----------------------------------------
_Right:
	C$hw2.c$68$1$35 ==.
;	C:\SiLabs\LITEC\Homework2\hw2.c:68: printf("\nGood job \r\n");
	mov	a,#___str_3
	push	acc
	mov	a,#(___str_3 >> 8)
	push	acc
	...
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'Wrong'
;------------------------------------------------------------
	G$Wrong$0$0 ==.
	C$hw2.c$71$1$35 ==.
;	C:\SiLabs\LITEC\Homework2\hw2.c:71: void Wrong(void)
;	-----------------------------------------
;	 function Wrong
;	-----------------------------------------
_Wrong:
	C$hw2.c$73$1$37 ==.
;	C:\SiLabs\LITEC\Homework2\hw2.c:73: printf("\nOops \r\n");
	mov	a,#___str_4
	push	acc
	mov	a,#(___str_4 >> 8)
	push	acc
	...
	dec	sp
	C$hw2.c$74$1$37 ==.
;	C:\SiLabs\LITEC\Homework2\hw2.c:74: printf("Not quite right \r\n");
	mov	a,#___str_5
	push	acc
	mov	a,#(___str_5 >> 8)
	push	acc
...
Fhw2$__str_1$0$0 == .
___str_1:
	.ascii "Enter a one digit number greater than 5 "
	.db 0x0d
	.db 0x0a
	.db 0x00
Fhw2$__str_2$0$0 == .

...
F:G$T0_ISR$0$0({2}DF,SV:S),Z,0,0,1,1,0
F:G$Counter_off$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Counter_on$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lworksheet_05.getchar$c$1$10({1}SC:U),R,0,0,[]
S:Lworksheet_05.getchar_nw$c$1$12({1}SC:U),R,0,0,[]
...
S:Fworksheet_05$__str_0$0$0({8}DA8d,SC:S),D,0,0
S:Fworksheet_05$__str_1$0$0({43}DA43d,SC:S),D,0,0

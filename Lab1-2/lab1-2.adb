...
T:Flab1_2$tm[({0}S:S$tm_sec$0$0({1}SC:U),Z,0,0)({1}S:S$tm_min$0$0({1}SC:U),Z,0,0)({2}S:S$tm_hour$0$0({1}SC:U),Z,0,0)({3}S:S$tm_mday$0$0({1}SC:U),Z,0,0)({4}S:S$tm_mon$0$0({1}SC:U),Z,0,0)({5}S:S$tm_year$0$0({2}SI:S),Z,0,0)({7}S:S$tm_wday$0$0({1}SC:U),Z,0,0)({8}S:S$tm_yday$0$0({2}SI:S),Z,0,0)({10}S:S$tm_isdst$0$0({1}SC:U),Z,0,0)({11}S:S$tm_hundredth$0$0({1}SC:U),Z,0,0)]
S:Llab1_2.getchar$c$1$10({1}SC:U),R,0,0,[]
S:Llab1_2.getchar_nw$c$1$12({1}SC:U),R,0,0,[]
S:G$Counts$0$0({2}SI:U),E,0,0
S:G$correct$0$0({1}SC:U),E,0,0
S:G$option$0$0({1}SC:U),E,0,0
S:G$attempt$0$0({1}SC:U),E,0,0
S:G$temp$0$0({1}SC:U),E,0,0
S:G$say$0$0({1}SC:U),E,0,0
...
S:Flab1_2$__str_1$0$0({43}DA43d,SC:S),D,0,0
S:Flab1_2$__str_2$0$0({34}DA34d,SC:S),D,0,0
S:Flab1_2$__str_3$0$0({10}DA10d,SC:S),D,0,0

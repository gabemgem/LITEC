...
;--------------------------------------------------------
	...
	C$lab6.c$32$1$155 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:32: unsigned char ccount = 0;//counter for the compass
	mov	_ccount,#0x00
	C$lab6.c$33$1$155 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:33: unsigned char rcount = 0;//counter for the ranger
	mov	_rcount,#0x00
	C$lab6.c$34$1$155 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:34: unsigned char count = 0;//general counter for delays
	mov	_count,#0x00
	C$lab6.c$36$1$155 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:36: signed int heading = 2100;//actual heading, updated from compass
	mov	_heading,#0x34
	mov	(_heading + 1),#0x08
	C$lab6.c$37$1$155 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:37: signed int desired = 2700;//desired heading, set by ranger
	mov	_desired,#0x8c
	mov	(_desired + 1),#0x0a
	C$lab6.c$38$1$155 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:38: signed int desired_original=2700;//original desired heading set by user
	mov	_desired_original,#0x8c
	mov	(_desired_original + 1),#0x0a
	C$lab6.c$39$1$155 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:39: unsigned char print_count = 0;//counter for printing readings
	mov	_print_count,#0x00
	C$lab6.c$40$1$155 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:40: unsigned char input='a';//used for getting input
	mov	_input,#0x61
	C$lab6.c$42$1$155 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:42: unsigned int battery=0;//holds battery voltage from ADC
	clr	a
	mov	_battery,a
	mov	(_battery + 1),a
	C$lab6.c$43$1$155 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:43: unsigned int rangervalue=50;//holds data from the ranger
	mov	_rangervalue,#0x32
;	1-genFromRTrack replaced	mov	(_rangervalue + 1),#0x00
	mov	(_rangervalue + 1),a
	C$lab6.c$51$1$155 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:51: signed long left_PW = 2765;//pulsewidth for left motor
	mov	_left_PW,#0xcd
	mov	(_left_PW + 1),#0x0a
	mov	(_left_PW + 2),a
	mov	(_left_PW + 3),a
	C$lab6.c$52$1$155 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:52: signed long right_PW = 2765;//pulsewidth for right motor
	mov	_right_PW,#0xcd
	mov	(_right_PW + 1),#0x0a
	mov	(_right_PW + 2),a
	mov	(_right_PW + 3),a
	C$lab6.c$53$1$155 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:53: signed int error=0;//heading error
	mov	_error,a
	mov	(_error + 1),a
	C$lab6.c$54$1$155 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:54: signed int prev_error=0;//previous heading error
	mov	_prev_error,a
	mov	(_prev_error + 1),a
	C$lab6.c$55$1$155 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:55: float kp=.3;//p gain
	mov	_kp,#0x9a
	mov	(_kp + 1),#0x99
	mov	(_kp + 2),#0x99
	mov	(_kp + 3),#0x3e
	C$lab6.c$56$1$155 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:56: unsigned int kd=160;//d gain
	mov	_kd,#0xa0
;	1-genFromRTrack replaced	mov	(_kd + 1),#0x00
	mov	(_kd + 1),a
	C$lab6.c$59$1$155 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:59: unsigned int PW_vert = 3502;//calibrated at beginning of program
	mov	_PW_vert,#0xae
	mov	(_PW_vert + 1),#0x0d
	C$lab6.c$60$1$155 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:60: unsigned int angle_PW = 3064;//used to set rotor angle
	mov	_angle_PW,#0xf8
	mov	(_angle_PW + 1),#0x0b
	.area GSFINAL (CODE)
...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$lab6.c$64$1$113 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:64: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$lab6.c$66$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:66: Sys_Init();
	lcall	_Sys_Init
	C$lab6.c$67$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:67: putchar(' ');
	mov	dpl,#0x20
	lcall	_putchar
	C$lab6.c$68$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:68: Port_Init();
	lcall	_Port_Init
	C$lab6.c$69$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:69: ADC_Init();
	lcall	_ADC_Init
	C$lab6.c$70$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:70: XBR0_Init();
	lcall	_XBR0_Init
	C$lab6.c$71$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:71: PCA_Init();
	lcall	_PCA_Init
	C$lab6.c$72$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:72: SMB_Init();
	lcall	_SMB_Init
	C$lab6.c$73$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:73: Interrupt_Init();
	lcall	_Interrupt_Init
	C$lab6.c$75$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:75: printf("Choose a desired heading:\n\r1) 0\n\r2) 90\n\r3) 180\n\r4) 270\n\r");
	mov	a,#___str_3
	push	acc
	mov	a,#(___str_3 >> 8)
	push	acc
	...
	dec	sp
	C$lab6.c$76$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:76: input=getchar();
	lcall	_getchar
	mov	_input,dpl
	C$lab6.c$77$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:77: if(input=='1')//user chooses desired heading of 0, 90, 180, or 270 degrees
	mov	a,#0x31
	cjne	a,_input,00108$
	C$lab6.c$78$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:78: desired_original=0;
	clr	a
	mov	_desired_original,a
	mov	(_desired_original + 1),a
	sjmp	00109$
00108$:
	C$lab6.c$79$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:79: else if(input=='2')
	mov	a,#0x32
	cjne	a,_input,00105$
	C$lab6.c$80$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:80: desired_original=900;
	mov	_desired_original,#0x84
	mov	(_desired_original + 1),#0x03
	sjmp	00109$
00105$:
	C$lab6.c$81$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:81: else if(input=='3')
	mov	a,#0x33
	cjne	a,_input,00102$
	C$lab6.c$82$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:82: desired_original=1800;
	mov	_desired_original,#0x08
	mov	(_desired_original + 1),#0x07
	sjmp	00109$
00102$:
	C$lab6.c$84$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:84: desired_original=2700;
	mov	_desired_original,#0x8c
	mov	(_desired_original + 1),#0x0a
00109$:
	C$lab6.c$86$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:86: desired=desired_original;
	mov	_desired,_desired_original
	mov	(_desired + 1),(_desired_original + 1)
	C$lab6.c$89$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:89: printf("\n\rPress u and d for up and down until the rotors are vertical. Press space when done.\n\r");
	mov	a,#___str_4
	push	acc
	mov	a,#(___str_4 >> 8)
	push	acc
	...
	dec	sp
	C$lab6.c$90$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:90: input=getchar();
	lcall	_getchar
	mov	_input,dpl
	C$lab6.c$91$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:91: while(input!=' ') {//calibrate rotor angle because gondolas differ
00115$:
	mov	a,#0x20
	cjne	a,_input,00162$
	sjmp	00117$
00162$:
	C$lab6.c$92$2$127 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:92: if(input=='u')
	mov	a,#0x75
	cjne	a,_input,00113$
	C$lab6.c$93$2$127 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:93: angle_PW+=50;
	mov	a,#0x32
	add	a,_angle_PW
	mov	_angle_PW,a
	clr	a
...
00113$:
	C$lab6.c$94$2$127 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:94: else if(input=='d')
	mov	a,#0x64
	cjne	a,_input,00114$
	C$lab6.c$95$2$127 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:95: angle_PW-=50;
	mov	a,_angle_PW
	add	a,#0xce
	mov	_angle_PW,a
	mov	a,(_angle_PW + 1)
...
00114$:
	C$lab6.c$96$2$127 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:96: PCA0CP1 = 0xFFFF-angle_PW;
	mov	a,#0xff
	clr	c
	subb	a,_angle_PW
	...
	C$lab6.c$97$2$127 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:97: input=getchar();
	lcall	_getchar
	mov	_input,dpl
	sjmp	00115$
00117$:
	C$lab6.c$99$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:99: PW_vert=angle_PW;
	mov	_PW_vert,_angle_PW
	mov	(_PW_vert + 1),(_angle_PW + 1)
	C$lab6.c$100$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:100: printf("\n\rDesired Heading:%u\n\r", desired);
	push	_desired
	push	(_desired + 1)
	mov	a,#___str_5
	push	acc
	...
	mov	sp,a
	C$lab6.c$102$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:102: PCA0CP1 = 0xFFFF-PW_vert;
	mov	a,#0xff
	clr	c
	subb	a,_PW_vert
	mov	((_PCA0CP1 >> 0) & 0xFF),a
	...
	mov	((_PCA0CP1 >> 8) & 0xFF),a
	C$lab6.c$104$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:104: PCA0CP2 = 0xFFFF-PW_neut;//start motors at neutral
	mov	((_PCA0CP2 >> 0) & 0xFF),#0x32
	mov	((_PCA0CP2 >> 8) & 0xFF),#0xf5
	C$lab6.c$105$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:105: PCA0CP3 = 0xFFFF-PW_neut;
	mov	((_PCA0CP3 >> 0) & 0xFF),#0x32
	mov	((_PCA0CP3 >> 8) & 0xFF),#0xf5
	C$lab6.c$106$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:106: ccount=0;
	mov	_ccount,#0x00
	C$lab6.c$107$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:107: while(ccount<50);
00118$:
	mov	a,#0x100 - 0x32
	add	a,_ccount
	jnc	00118$
	C$lab6.c$109$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:109: ccount=0;//reset counters
	mov	_ccount,#0x00
	C$lab6.c$110$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:110: rcount=0;
	mov	_rcount,#0x00
	C$lab6.c$111$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:111: print_count=0;
	mov	_print_count,#0x00
	C$lab6.c$112$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:112: while(1) {
00122$:
	C$lab6.c$113$2$128 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:113: Steering_Servo();//get compass data and control rotors
	lcall	_Steering_Servo
	C$lab6.c$114$2$128 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:114: Ranger();//get ranger data and control desired heading
	lcall	_Ranger
	sjmp	00122$
	C$lab6.c$118$1$126 ==.
	XG$main$0$0 ==.
...
;------------------------------------------------------------
	G$Ranger$0$0 ==.
	C$lab6.c$120$1$126 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:120: void Ranger(void) {//get ranger data and control desired heading
;	-----------------------------------------
;	 function Ranger
;	-----------------------------------------
_Ranger:
	C$lab6.c$121$1$130 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:121: if(rcount>=4) {//every 80ms
	mov	a,#0x100 - 0x04
	add	a,_rcount
	jnc	00102$
	C$lab6.c$122$2$131 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:122: rangervalue = ReadRanger();//get ranger value
	lcall	_ReadRanger
	mov	_rangervalue,dpl
	mov	(_rangervalue + 1),dph
	C$lab6.c$123$2$131 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:123: Data[0] = 0x51;                //sets results in cm
	mov	_Data,#0x51
	C$lab6.c$124$2$131 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:124: i2c_write_data(0xE0,0,Data,1);    //Write one byte of data to reg 0 at addr			
	...
	lcall	_i2c_write_data
	C$lab6.c$125$2$131 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:125: rcount=0;//reset ranger counter
	mov	_rcount,#0x00
00102$:
	C$lab6.c$128$1$130 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:128: if(rangervalue>45 && rangervalue<55)//if at 50cm +-5
	clr	c
	mov	a,#0x2d
	subb	a,_rangervalue
	clr	a
	subb	a,(_rangervalue + 1)
	jnc	00113$
	clr	c
	mov	a,_rangervalue
	subb	a,#0x37
	...
	jnc	00113$
	C$lab6.c$129$1$130 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:129: desired = desired_original;//keep desired heading at original choice
	mov	_desired,_desired_original
	mov	(_desired + 1),(_desired_original + 1)
	ljmp	00114$
00113$:
	C$lab6.c$131$1$130 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:131: else if(rangervalue<45) {//if value is less than 45cm
	clr	c
	mov	a,_rangervalue
	subb	a,#0x2d
	mov	a,(_rangervalue + 1)
	...
	jnc	00110$
	C$lab6.c$132$2$132 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:132: if(rangervalue<=5)//if value is less than 5cm
	clr	c
	mov	a,#0x05
	subb	a,_rangervalue
	clr	a
	...
	jc	00104$
	C$lab6.c$133$2$132 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:133: desired = desired_original-1800;//decrease desired heading by 180degrees
	mov	a,_desired_original
	add	a,#0xf8
	mov	_desired,a
	mov	a,(_desired_original + 1)
	addc	a,#0xf8
	mov	(_desired + 1),a
	sjmp	00114$
00104$:
	C$lab6.c$135$1$130 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:135: desired = desired_original-(-45*rangervalue+2025);
	mov	__mulint_PARM_2,_rangervalue
	mov	(__mulint_PARM_2 + 1),(_rangervalue + 1)
	mov	dptr,#0xffd3
	lcall	__mulint
	mov	a,dpl
	mov	b,dph
	...
	addc	a,b
	mov	r7,a
	mov	r4,_desired_original
	mov	r5,(_desired_original + 1)
	mov	a,r4
	clr	c
	subb	a,r6
	mov	_desired,a
...
00110$:
	C$lab6.c$140$2$133 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:140: if(rangervalue>95)//if value is greater than 95cm
	clr	c
	mov	a,#0x5f
	subb	a,_rangervalue
	clr	a
	...
	jnc	00107$
	C$lab6.c$141$2$133 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:141: desired = desired_original+1800;//increase desired heading by 180 degrees
	mov	a,#0x08
	add	a,_desired_original
	mov	_desired,a
	mov	a,#0x07
	addc	a,(_desired_original + 1)
	mov	(_desired + 1),a
	sjmp	00114$
00107$:
	C$lab6.c$143$1$130 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:143: desired = desired_original+(45*rangervalue-2475);
	mov	__mulint_PARM_2,_rangervalue
	mov	(__mulint_PARM_2 + 1),(_rangervalue + 1)
	mov	dptr,#0x002d
	lcall	__mulint
...
00114$:
	C$lab6.c$146$1$130 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:146: if(desired<0)//adjust desired heading to be withing 0 and 360 degrees
	mov	a,(_desired + 1)
	jnb	acc.7,00119$
	C$lab6.c$147$1$130 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:147: desired=3600+desired;
	mov	a,#0x10
	add	a,_desired
	mov	_desired,a
	mov	a,#0x0e
...
00119$:
	C$lab6.c$148$1$130 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:148: else if(desired>3600)
	clr	c
	mov	a,#0x10
	subb	a,_desired
	mov	a,#(0x0e ^ 0x80)
	...
	jnc	00121$
	C$lab6.c$149$1$130 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:149: desired-=3600;
	mov	a,_desired
	add	a,#0xf0
	mov	_desired,a
	mov	a,(_desired + 1)
...
;------------------------------------------------------------
	G$ReadRanger$0$0 ==.
	C$lab6.c$152$1$130 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:152: unsigned int ReadRanger(void) {//read data from the ranger
;	-----------------------------------------
;	 function ReadRanger
;	-----------------------------------------
_ReadRanger:
	C$lab6.c$155$1$135 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:155: i2c_read_data(addr,2, Data, 2);    // read two bytes, starting at reg 2 
	...
	lcall	_i2c_read_data
	C$lab6.c$156$1$135 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:156: range = (((unsigned int)Data[0] << 8) | Data[1]);    //value read from i2c 
	mov	r7,_Data
	mov	r6,#0x00
	mov	r4,(_Data + 0x0001)
	mov	r5,#0x00
	...
	mov	dph,a
	C$lab6.c$157$1$135 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:157: return range;
	C$lab6.c$158$1$135 ==.
	XG$ReadRanger$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$Read_Compass$0$0 ==.
	C$lab6.c$161$1$135 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:161: void Read_Compass(void) {//read data from the compass
;	-----------------------------------------
;	 function Read_Compass
;	-----------------------------------------
_Read_Compass:
	C$lab6.c$162$1$137 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:162: i2c_read_data(0xC0, 2, Data, 2);//read two bytes starting at reg. 2
	mov	_i2c_read_data_PARM_3,#_Data
	mov	(_i2c_read_data_PARM_3 + 1),#0x00
	mov	(_i2c_read_data_PARM_3 + 2),#0x40
	mov	_i2c_read_data_PARM_2,#0x02
	...
	lcall	_i2c_read_data
	C$lab6.c$163$1$137 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:163: heading = (((unsigned int)Data[0]<<8) | Data[1]);//combine data
	mov	r7,_Data
	mov	r6,#0x00
	mov	r4,(_Data + 0x0001)
	mov	r5,#0x00
...
;------------------------------------------------------------
	...
	C$lab6.c$166$1$137 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:166: void Steering_Servo(void) {//control rotors from compass data
;	-----------------------------------------
;	 function Steering_Servo
;	-----------------------------------------
_Steering_Servo:
	C$lab6.c$167$1$139 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:167: if(ccount>=2) {//every 40ms
	mov	a,#0x100 - 0x02
	add	a,_ccount
	jnc	00102$
	C$lab6.c$168$2$140 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:168: print_count++;//increment print counter
	inc	_print_count
	C$lab6.c$169$2$140 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:169: Read_Compass();//get compass data
	lcall	_Read_Compass
	C$lab6.c$170$2$140 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:170: ccount=0;//reset compass counter
	mov	_ccount,#0x00
00102$:
	C$lab6.c$173$1$139 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:173: error=desired-heading;//calculate error
	mov	a,_desired
	clr	c
	subb	a,_heading
	mov	_error,a
	...
	mov	(_error + 1),a
	C$lab6.c$174$1$139 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:174: if(error>1800)//adjust error if out of bounds
	clr	c
	mov	a,#0x08
	subb	a,_error
	mov	a,#(0x07 ^ 0x80)
	...
	jnc	00106$
	C$lab6.c$175$1$139 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:175: error-=3600;
	mov	a,_error
	add	a,#0xf0
	mov	_error,a
	mov	a,(_error + 1)
...
00106$:
	C$lab6.c$176$1$139 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:176: else if(error<-1800)
	clr	c
	mov	a,_error
	subb	a,#0xf8
	mov	a,(_error + 1)
	...
	jnc	00107$
	C$lab6.c$177$1$139 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:177: error+=3600;
	mov	a,#0x10
	add	a,_error
	mov	_error,a
	mov	a,#0x0e
...
00107$:
	C$lab6.c$180$1$139 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:180: left_PW=(long)PW_neut - (kp*(long)error + kd*(long)(error-prev_error));
	mov	r4,_error
	mov	a,(_error + 1)
	mov	r5,a
	rlc	a
	...
	pop	ar7
	C$lab6.c$181$1$139 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:181: right_PW=(long)PW_neut + (kp*(long)error + kd*(long)(error-prev_error));
	clr	a
	push	acc
	mov	a,#0xd0
	push	acc
	...
	mov	(_right_PW + 3),a
	C$lab6.c$186$1$139 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:186: if(left_PW>PW_max) 
	clr	c
	mov	a,#0xae
	subb	a,_left_PW
	mov	a,#0x0d
	...
	jnc	00111$
	C$lab6.c$187$1$139 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:187: left_PW=PW_max;
	mov	_left_PW,#0xae
	mov	(_left_PW + 1),#0x0d
	clr	a
	mov	(_left_PW + 2),a
...
00111$:
	C$lab6.c$188$1$139 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:188: else if(left_PW<PW_min)
	clr	c
	mov	a,_left_PW
	subb	a,#0xec
	mov	a,(_left_PW + 1)
	...
	jnc	00112$
	C$lab6.c$189$1$139 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:189: left_PW=PW_min;
	mov	_left_PW,#0xec
	mov	(_left_PW + 1),#0x07
	clr	a
	mov	(_left_PW + 2),a
...
00112$:
	C$lab6.c$191$1$139 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:191: if(right_PW>PW_max) 
	clr	c
	mov	a,#0xae
	subb	a,_right_PW
	mov	a,#0x0d
	...
	jnc	00116$
	C$lab6.c$192$1$139 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:192: right_PW=PW_max;
	mov	_right_PW,#0xae
...
00116$:
	C$lab6.c$193$1$139 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:193: else if(right_PW<PW_min)
	clr	c
	mov	a,_right_PW
	subb	a,#0xec
	mov	a,(_right_PW + 1)
	...
	jnc	00117$
	C$lab6.c$194$1$139 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:194: right_PW=PW_min;
	mov	_right_PW,#0xec
...
00117$:
	C$lab6.c$196$1$139 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:196: if(print_count>=25) {//every 1 second
	mov	a,#0x100 - 0x19
	add	a,_print_count
	jc	00153$
	ljmp	00119$
00153$:
	C$lab6.c$197$2$141 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:197: ADC_Convert();//get adc value
	lcall	_ADC_Convert
	C$lab6.c$198$1$139 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:198: battery = 14800*((float)battery/256.0);//convert battery data to mV
	mov	dpl,_battery
	mov	dph,(_battery + 1)
	lcall	___uint2fs
	mov	r4,dpl
...
;	C:\SiLabs\LITEC\Lab6\lab6.c:200: printf("\n\rDes. Head:%u Head.:%u, Ranger:%u, LPW:%ld, Batt.(mV):%u", desired, heading, rangervalue, left_PW, battery);
	...
	mov	sp,a
	C$lab6.c$202$2$141 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:202: print_count=0;//reset print counter
	mov	_print_count,#0x00
00119$:
	C$lab6.c$206$1$139 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:206: PCA0CP2 = 0xFFFF-left_PW;//set motors
	mov	a,#0xff
	clr	c
	subb	a,_left_PW
	mov	r4,a
	...
	C$lab6.c$207$1$139 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:207: PCA0CP3 = 0xFFFF-right_PW;
	mov	a,#0xff
	clr	c
	subb	a,_right_PW
	mov	r4,a
	...
	clr	a
	subb	a,(_right_PW + 3)
	mov	((_PCA0CP3 >> 0) & 0xFF),r4
	mov	((_PCA0CP3 >> 8) & 0xFF),r5
	C$lab6.c$209$1$139 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:209: prev_error=error;//store error for next loop
...
;------------------------------------------------------------
	G$Port_Init$0$0 ==.
	C$lab6.c$212$1$139 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:212: void Port_Init()
;	-----------------------------------------
;	 function Port_Init
;	-----------------------------------------
_Port_Init:
	C$lab6.c$214$1$142 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:214: P0MDOUT = 0xF0;//set output pin for CEX0,1,2,3 in push-pull mode
	mov	_P0MDOUT,#0xf0
	C$lab6.c$215$1$142 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:215: P1MDOUT &= ~0x08;//set pin for battery in open-drain mode
	anl	_P1MDOUT,#0xf7
	C$lab6.c$216$1$142 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:216: P1 |=0x08;//set pin for battery in high-impedance
	orl	_P1,#0x08
	C$lab6.c$217$1$142 ==.
	XG$Port_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$XBR0_Init$0$0 ==.
	C$lab6.c$219$1$142 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:219: void XBR0_Init()
;	-----------------------------------------
;	 function XBR0_Init
;	-----------------------------------------
_XBR0_Init:
	C$lab6.c$221$1$143 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:221: XBR0 = 0x25; //configure crossbar with UART, SMBus, and CEX channels 0,1,2,3
	mov	_XBR0,#0x25
	C$lab6.c$222$1$143 ==.
	XG$XBR0_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$SMB_Init$0$0 ==.
	C$lab6.c$224$1$143 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:224: void SMB_Init(void) {//Set up i2c
;	-----------------------------------------
;	 function SMB_Init
;	-----------------------------------------
_SMB_Init:
	C$lab6.c$225$1$145 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:225: SMB0CR = 0x93; //run at 100kHZ
	mov	_SMB0CR,#0x93
	C$lab6.c$226$1$145 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:226: ENSMB = 1; //enable smbus
	setb	_ENSMB
	C$lab6.c$227$1$145 ==.
	XG$SMB_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$ADC_Init$0$0 ==.
	C$lab6.c$229$1$145 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:229: void ADC_Init(void) {		//initialize ADC
;	-----------------------------------------
;	 function ADC_Init
;	-----------------------------------------
_ADC_Init:
	C$lab6.c$230$1$147 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:230: REF0CN = 0x03; 			//set Vref to use 2.4V
	mov	_REF0CN,#0x03
	C$lab6.c$231$1$147 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:231: ADC1CF |= 0x01;			//set gain of 1
	orl	_ADC1CF,#0x01
	C$lab6.c$232$1$147 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:232: ADC1CN = 0x80; 			//enable A/D converter
	mov	_ADC1CN,#0x80
	C$lab6.c$234$1$147 ==.
	XG$ADC_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$ADC_Convert$0$0 ==.
	C$lab6.c$236$1$147 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:236: void ADC_Convert(void) {
;	-----------------------------------------
;	 function ADC_Convert
;	-----------------------------------------
_ADC_Convert:
	C$lab6.c$237$1$149 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:237: AMX1SL = 3;			//Set ADC to convert value on pin 3
	mov	_AMX1SL,#0x03
	C$lab6.c$238$1$149 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:238: ADC1CN &= ~0x20;//clear flag		
	anl	_ADC1CN,#0xdf
	C$lab6.c$239$1$149 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:239: ADC1CN |= 0x10;//start conversion
	orl	_ADC1CN,#0x10
	C$lab6.c$240$1$149 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:240: while((ADC1CN & 0x20)==0x00);//wait for conversion to finish
00101$:
	mov	a,_ADC1CN
	jnb	acc.5,00101$
	C$lab6.c$241$1$149 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:241: battery = ADC1;//store adc value
	mov	_battery,_ADC1
	mov	(_battery + 1),#0x00
	C$lab6.c$242$1$149 ==.
	XG$ADC_Convert$0$0 ==.
...
;------------------------------------------------------------
	G$PCA_Init$0$0 ==.
	C$lab6.c$244$1$149 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:244: void PCA_Init(void)
;	-----------------------------------------
;	 function PCA_Init
;	-----------------------------------------
_PCA_Init:
	C$lab6.c$246$1$151 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:246: PCA0MD = 0x81; //SYSCLK/12, enable CF interrupts, suspend when idle
	mov	_PCA0MD,#0x81
	C$lab6.c$247$1$151 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:247: PCA0CPM1 = 0xC2; //16 bit, enable compare, enable PWM
	mov	_PCA0CPM1,#0xc2
	C$lab6.c$248$1$151 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:248: PCA0CPM2 = 0xC2; //set up CEX2 the same as CEX1
	mov	_PCA0CPM2,#0xc2
	C$lab6.c$249$1$151 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:249: PCA0CPM3 = 0xC2; //set up CEX3 the same as CEX1
	mov	_PCA0CPM3,#0xc2
	C$lab6.c$250$1$151 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:250: PCA0CN |= 0x40; // enable PCA
	orl	_PCA0CN,#0x40
	C$lab6.c$251$1$151 ==.
	XG$PCA_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	...
	C$lab6.c$253$1$151 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:253: void Interrupt_Init(void)
;	-----------------------------------------
;	 function Interrupt_Init
;	-----------------------------------------
_Interrupt_Init:
	C$lab6.c$255$1$153 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:255: EIE1 |= 0x08;//enable PCA interrupts
	orl	_EIE1,#0x08
	C$lab6.c$257$1$153 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:257: EA=1;//enable all interrupts
	setb	_EA
	C$lab6.c$258$1$153 ==.
...
;------------------------------------------------------------
	G$PCA_ISR$0$0 ==.
	C$lab6.c$260$1$153 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:260: void PCA_ISR ( void ) __interrupt 9
;	-----------------------------------------
;	 function PCA_ISR
;	-----------------------------------------
_PCA_ISR:
	C$lab6.c$262$1$155 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:262: if(CF) {
	jnb	_CF,00102$
	C$lab6.c$263$2$156 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:263: PCA0 = PCA_start;//Start count
	mov	((_PCA0 >> 0) & 0xFF),#0xff
	mov	((_PCA0 >> 8) & 0xFF),#0x6f
	C$lab6.c$264$2$156 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:264: CF=0;//clear interrupt flag
	clr	_CF
	C$lab6.c$265$2$156 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:265: ccount++;//increment compass counter
	inc	_ccount
	C$lab6.c$266$2$156 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:266: rcount++;//increment ranger counter
	inc	_rcount
	C$lab6.c$267$2$156 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:267: count++;//increment general counter
	inc	_count
	sjmp	00104$
00102$:
	C$lab6.c$269$1$155 ==.
;	C:\SiLabs\LITEC\Lab6\lab6.c:269: else PCA0CN &= 0xC0;//all other type 9 interrupts
	anl	_PCA0CN,#0xc0
00104$:
	C$lab6.c$270$1$155 ==.
	XG$PCA_ISR$0$0 ==.
...
Flab6$__str_3$0$0 == .
___str_3:
	.ascii "Choose a desired heading:"
	.db 0x0a
	.db 0x0d
	.ascii "1) 0"
	.db 0x0a
...
___str_4:
	.db 0x0a
	.db 0x0d
	.ascii "Press u and d for up and down until the rotors are vertica"
	.ascii "l. Press space when done."
	.db 0x0a
	.db 0x0d
	.db 0x00
Flab6$__str_5$0$0 == .
...
___str_6:
	.db 0x0a
	.db 0x0d
	.ascii "Des. Head:%u Head.:%u, Ranger:%u, LPW:%ld, Batt.(mV):%u"
	.db 0x00
	.area XINIT   (CODE)
	.area CABS    (ABS,CODE)

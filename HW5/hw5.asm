...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$hw5.c$36$1$12 ==.
;	C:\SiLabs\LITEC\HW5\hw5.c:36: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$hw5.c$38$1$31 ==.
;	C:\SiLabs\LITEC\HW5\hw5.c:38: Sys_Init();      // System Initialization
	lcall	_Sys_Init
	C$hw5.c$39$1$31 ==.
;	C:\SiLabs\LITEC\HW5\hw5.c:39: putchar(' ');    // the quote fonts may not copy correctly into SiLabs IDE
	mov	dpl,#0x20
	lcall	_putchar
	C$hw5.c$40$1$31 ==.
;	C:\SiLabs\LITEC\HW5\hw5.c:40: Interrupt_Init();
	lcall	_Interrupt_Init
	C$hw5.c$41$1$31 ==.
;	C:\SiLabs\LITEC\HW5\hw5.c:41: Timer_Init();    // Initialize Timer 0 
	lcall	_Timer_Init
	C$hw5.c$43$1$31 ==.
;	C:\SiLabs\LITEC\HW5\hw5.c:43: while (1) /* the following loop waits after a key is pressed on the
00105$:
	C$hw5.c$46$2$32 ==.
;	C:\SiLabs\LITEC\HW5\hw5.c:46: printf("Hit any key on the keyboard to start \r\n");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
	C$hw5.c$47$2$32 ==.
;	C:\SiLabs\LITEC\HW5\hw5.c:47: input = getchar();
	lcall	_getchar
	mov	_input,dpl
	C$hw5.c$49$2$32 ==.
;	C:\SiLabs\LITEC\HW5\hw5.c:49: TL0=0;//clear low byte
	mov	_TL0,#0x00
	C$hw5.c$50$2$32 ==.
;	C:\SiLabs\LITEC\HW5\hw5.c:50: TH0=0;//clear high byte
	mov	_TH0,#0x00
	C$hw5.c$51$2$32 ==.
;	C:\SiLabs\LITEC\HW5\hw5.c:51: TR0=1;// start Timer0
	setb	_TR0
	C$hw5.c$53$2$32 ==.
;	C:\SiLabs\LITEC\HW5\hw5.c:53: while(counts<=14400){}// 2 second delay
00101$:
	clr	c
	mov	a,#0x40
	subb	a,_counts
	...
	jnc	00101$
	C$hw5.c$55$2$32 ==.
;	C:\SiLabs\LITEC\HW5\hw5.c:55: printf("2 seconds have passed. \r\n");  //print that the time has elapsed
	mov	a,#___str_1
	push	acc
	mov	a,#(___str_1 >> 8)
	push	acc
	...
	dec	sp
	C$hw5.c$57$2$32 ==.
;	C:\SiLabs\LITEC\HW5\hw5.c:57: printf("%u overflows have happened", counts);// print number of overflows using count variable
	push	_counts
	push	(_counts + 1)
	mov	a,#___str_2
	push	acc
...
;------------------------------------------------------------
	...
	C$hw5.c$64$1$31 ==.
;	C:\SiLabs\LITEC\HW5\hw5.c:64: void Interrupt_Init(void)
;	-----------------------------------------
;	 function Interrupt_Init
;	-----------------------------------------
_Interrupt_Init:
	C$hw5.c$66$1$35 ==.
;	C:\SiLabs\LITEC\HW5\hw5.c:66: ET0 = 1;      // enable Timer0 Interrupt request using sbit variable 
	setb	_ET0
	C$hw5.c$67$1$35 ==.
;	C:\SiLabs\LITEC\HW5\hw5.c:67: IE |= 0x80;       // enable global interrupts using bit masking
	orl	_IE,#0x80
	C$hw5.c$68$1$35 ==.
...
;------------------------------------------------------------
	G$Timer_Init$0$0 ==.
	C$hw5.c$70$1$35 ==.
;	C:\SiLabs\LITEC\HW5\hw5.c:70: void Timer_Init(void)
;	-----------------------------------------
;	 function Timer_Init
;	-----------------------------------------
_Timer_Init:
	C$hw5.c$73$1$37 ==.
;	C:\SiLabs\LITEC\HW5\hw5.c:73: CKCON &= 0xF7;  // Timer0 uses SYSCLK/12
	anl	_CKCON,#0xf7
	C$hw5.c$74$1$37 ==.
;	C:\SiLabs\LITEC\HW5\hw5.c:74: TMOD &= 0xF0;   // clear the 4 least significant bits
	anl	_TMOD,#0xf0
	C$hw5.c$75$1$37 ==.
;	C:\SiLabs\LITEC\HW5\hw5.c:75: TMOD |= 0x02;   // Timer0 mode setting
	orl	_TMOD,#0x02
	C$hw5.c$76$1$37 ==.
;	C:\SiLabs\LITEC\HW5\hw5.c:76: TR0 = 0;         // Stop Timer0
	clr	_TR0
	C$hw5.c$77$1$37 ==.
;	C:\SiLabs\LITEC\HW5\hw5.c:77: TL0 = 0;         // Clear low byte of register T0
	mov	_TL0,#0x00
	C$hw5.c$78$1$37 ==.
;	C:\SiLabs\LITEC\HW5\hw5.c:78: TH0 = 0;         // Clear high byte of register T0
	mov	_TH0,#0x00
	C$hw5.c$80$1$37 ==.
	XG$Timer_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$Timer0_ISR$0$0 ==.
	C$hw5.c$84$1$37 ==.
;	C:\SiLabs\LITEC\HW5\hw5.c:84: void Timer0_ISR(void) __interrupt 1
;	-----------------------------------------
;	 function Timer0_ISR
;	-----------------------------------------
_Timer0_ISR:
	...
	push	psw
	C$hw5.c$86$1$39 ==.
;	C:\SiLabs\LITEC\HW5\hw5.c:86: TF0 = 0;//clear interrupt request
	clr	_TF0
	C$hw5.c$87$1$39 ==.
;	C:\SiLabs\LITEC\HW5\hw5.c:87: counts++;//increment overflow counter
	inc	_counts
	clr	a
...
Fhw5$__str_1$0$0 == .
___str_1:
	.ascii "2 seconds have passed. "
	.db 0x0d
	.db 0x0a
	.db 0x00
Fhw5$__str_2$0$0 == .
___str_2:
	.ascii "%u overflows have happened"
	.db 0x00
	.area XINIT   (CODE)
	.area CABS    (ABS,CODE)

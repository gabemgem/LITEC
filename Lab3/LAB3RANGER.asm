...
_Data2::
	.ds 3
LLAB3RANGER.aligned_alloc$size$1$39==.
_aligned_alloc_PARM_2:
	.ds 2
LLAB3RANGER.lcd_clear$NumBytes$1$85==.
_lcd_clear_NumBytes_1_85:
	.ds 1
LLAB3RANGER.lcd_clear$Cmd$1$85==.
_lcd_clear_Cmd_1_85:
	.ds 2
LLAB3RANGER.read_keypad$Data$1$86==.
_read_keypad_Data_1_86:
	.ds 2
LLAB3RANGER.i2c_write_data$start_reg$1$105==.
_i2c_write_data_PARM_2:
	.ds 1
LLAB3RANGER.i2c_write_data$buffer$1$105==.
_i2c_write_data_PARM_3:
	.ds 3
LLAB3RANGER.i2c_write_data$num_bytes$1$105==.
_i2c_write_data_PARM_4:
	.ds 1
LLAB3RANGER.i2c_read_data$start_reg$1$107==.
_i2c_read_data_PARM_2:
	.ds 1
LLAB3RANGER.i2c_read_data$buffer$1$107==.
_i2c_read_data_PARM_3:
	.ds 3
LLAB3RANGER.i2c_read_data$num_bytes$1$107==.
...
_Data::
	.ds 2
LLAB3RANGER.ReadRanger$Data$1$127==.
_ReadRanger_Data_1_127:
	.ds 2
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
LLAB3RANGER.lcd_print$text$1$81==.
...
;--------------------------------------------------------
	...
	C$LAB3RANGER.c$22$1$135 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:22: unsigned int PCA_Start = 28671; //20ms     ratio of the max value to current period == count_value/period you want
	mov	_PCA_Start,#0xff
	mov	(_PCA_Start + 1),#0x6f
	C$LAB3RANGER.c$23$1$135 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:23: unsigned int count = 0;
	clr	a
	mov	_count,a
	mov	(_count + 1),a
	C$LAB3RANGER.c$24$1$135 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:24: unsigned int read_count=0;
	mov	_read_count,a
	mov	(_read_count + 1),a
	.area GSFINAL (CODE)
...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$LAB3RANGER.c$29$1$113 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:29: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$LAB3RANGER.c$32$1$122 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:32: Sys_Init();
	lcall	_Sys_Init
	C$LAB3RANGER.c$33$1$122 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:33: putchar(' ');
	mov	dpl,#0x20
	lcall	_putchar
	C$LAB3RANGER.c$34$1$122 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:34: Port_Init();
	lcall	_Port_Init
	C$LAB3RANGER.c$35$1$122 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:35: XBR0_Init();
	lcall	_XBR0_Init
	C$LAB3RANGER.c$36$1$122 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:36: PCA_Init();
	lcall	_PCA_Init
	C$LAB3RANGER.c$37$1$122 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:37: Interrupt_Init();
	lcall	_Interrupt_Init
	C$LAB3RANGER.c$40$1$122 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:40: printf("\n\rUltrasonic Ranger\r\n");
	mov	a,#___str_3
	push	acc
	mov	a,#(___str_3 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
	C$LAB3RANGER.c$43$1$122 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:43: count=0;
	clr	a
	mov	_count,a
	mov	(_count + 1),a
	C$LAB3RANGER.c$44$1$122 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:44: while(1)
00102$:
	C$LAB3RANGER.c$45$1$122 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:45: Ranger();
	lcall	_Ranger
	sjmp	00102$
	C$LAB3RANGER.c$48$1$122 ==.
	XG$main$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'Ranger'
;------------------------------------------------------------
;read_result               Allocated to registers r6 r7 
;------------------------------------------------------------
	G$Ranger$0$0 ==.
	C$LAB3RANGER.c$56$1$122 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:56: void Ranger(void)
;	-----------------------------------------
;	 function Ranger
;	-----------------------------------------
_Ranger:
	C$LAB3RANGER.c$61$1$124 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:61: if(count>=4)
	clr	c
	mov	a,_count
	subb	a,#0x04
	mov	a,(_count + 1)
	subb	a,#0x00
	jc	00105$
	C$LAB3RANGER.c$63$2$125 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:63: read_result = ReadRanger();
	lcall	_ReadRanger
	mov	r6,dpl
	mov	r7,dph
	C$LAB3RANGER.c$64$2$125 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:64: Data[0] = 0x51;              //write 0x51 to reg 0 of the ranger
	mov	_Data,#0x51
	C$LAB3RANGER.c$65$2$125 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:65: i2c_write_data(0xE0,0,Data,1);    //Write one byte of data to reg 0 at addr
	...
	pop	ar6
	pop	ar7
	C$LAB3RANGER.c$66$2$125 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:66: read_count++;  
	inc	_read_count
	clr	a
	cjne	a,_read_count,00114$
	inc	(_read_count + 1)
00114$:
	C$LAB3RANGER.c$67$2$125 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:67: if(read_count>=13) {      //Prints about every second
	clr	c
	mov	a,_read_count
	subb	a,#0x0d
	mov	a,(_read_count + 1)
	subb	a,#0x00
	jc	00102$
	C$LAB3RANGER.c$68$3$126 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:68: printf("Range: %u\n\r", read_result);
	push	ar6
	push	ar7
	mov	a,#___str_4
	push	acc
	...
	add	a,#0xfb
	mov	sp,a
	C$LAB3RANGER.c$69$3$126 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:69: read_count=0;
	clr	a
	mov	_read_count,a
	mov	(_read_count + 1),a
00102$:
	C$LAB3RANGER.c$71$2$125 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:71: count=0;
	clr	a
	mov	_count,a
	mov	(_count + 1),a
00105$:
	C$LAB3RANGER.c$73$1$124 ==.
	XG$Ranger$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'ReadRanger'
;------------------------------------------------------------
;Data                      Allocated with name '_ReadRanger_Data_1_127'
;range                     Allocated to registers 
;addr                      Allocated to registers 
;------------------------------------------------------------
	G$ReadRanger$0$0 ==.
	C$LAB3RANGER.c$83$1$124 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:83: unsigned int ReadRanger()
;	-----------------------------------------
;	 function ReadRanger
;	-----------------------------------------
_ReadRanger:
	C$LAB3RANGER.c$88$1$127 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:88: i2c_read_data(addr,2, Data, 2);    // read two bytes, starting at reg 2 
	mov	_i2c_read_data_PARM_3,#_ReadRanger_Data_1_127
	mov	(_i2c_read_data_PARM_3 + 1),#0x00
	mov	(_i2c_read_data_PARM_3 + 2),#0x40
	...
	mov	dpl,#0xe0
	lcall	_i2c_read_data
	C$LAB3RANGER.c$89$1$127 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:89: range = (((unsigned int)Data[0] << 8) | Data[1]);    //value read from i2c 
	mov	r7,_ReadRanger_Data_1_127
	mov	r6,#0x00
	mov	r4,(_ReadRanger_Data_1_127 + 0x0001)
	mov	r5,#0x00
	mov	a,r4
	orl	a,r6
	mov	dpl,a
	...
	orl	a,r7
	mov	dph,a
	C$LAB3RANGER.c$90$1$127 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:90: return range;
	C$LAB3RANGER.c$91$1$127 ==.
	XG$ReadRanger$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$Port_Init$0$0 ==.
	C$LAB3RANGER.c$102$1$127 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:102: void Port_Init()
;	-----------------------------------------
;	 function Port_Init
;	-----------------------------------------
_Port_Init:
	C$LAB3RANGER.c$105$1$127 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:105: }
	C$LAB3RANGER.c$105$1$127 ==.
	XG$Port_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	...
	C$LAB3RANGER.c$115$1$127 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:115: void Interrupt_Init()   //Enable interrupts
;	-----------------------------------------
;	 function Interrupt_Init
;	-----------------------------------------
_Interrupt_Init:
	C$LAB3RANGER.c$117$1$129 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:117: EIE1 |= 0x08; 
	orl	_EIE1,#0x08
	C$LAB3RANGER.c$118$1$129 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:118: EA = 1;
	setb	_EA
	C$LAB3RANGER.c$119$1$129 ==.
...
;------------------------------------------------------------
	G$XBR0_Init$0$0 ==.
	C$LAB3RANGER.c$129$1$129 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:129: void XBR0_Init()            //CEX2
;	-----------------------------------------
;	 function XBR0_Init
;	-----------------------------------------
_XBR0_Init:
	C$LAB3RANGER.c$131$1$130 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:131: XBR0 = 0x27; 
	mov	_XBR0,#0x27
	C$LAB3RANGER.c$133$1$130 ==.
	XG$XBR0_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$SMBUS_Init$0$0 ==.
	C$LAB3RANGER.c$139$1$130 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:139: void SMBUS_Init()
;	-----------------------------------------
;	 function SMBUS_Init
;	-----------------------------------------
_SMBUS_Init:
	C$LAB3RANGER.c$141$1$131 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:141: SMB0CR = 0x93;     //sets up the clock to 1000 kHz
	mov	_SMB0CR,#0x93
	C$LAB3RANGER.c$142$1$131 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:142: ENSMB = 1;	       //Enable the i2c
	setb	_ENSMB
	C$LAB3RANGER.c$143$1$131 ==.
	XG$SMBUS_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$PCA_Init$0$0 ==.
	C$LAB3RANGER.c$152$1$131 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:152: void PCA_Init(void)
;	-----------------------------------------
;	 function PCA_Init
;	-----------------------------------------
_PCA_Init:
	C$LAB3RANGER.c$155$1$133 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:155: PCA0MD = 0x81;		   //Used to set the mode for PCA0
	mov	_PCA0MD,#0x81
	C$LAB3RANGER.c$156$1$133 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:156: PCA0CPM2 = 0xC2;       //CCM Register
	mov	_PCA0CPM2,#0xc2
	C$LAB3RANGER.c$157$1$133 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:157: PCA0CN |= 0x40;		   //PCA Control Register
	orl	_PCA0CN,#0x40
	C$LAB3RANGER.c$158$1$133 ==.
	XG$PCA_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$PCA_ISR$0$0 ==.
	C$LAB3RANGER.c$168$1$133 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:168: void PCA_ISR(void) __interrupt 9
;	-----------------------------------------
;	 function PCA_ISR
;	-----------------------------------------
_PCA_ISR:
	push	acc
	push	psw
	C$LAB3RANGER.c$170$1$135 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:170: if(CF)
	jnb	_CF,00102$
	C$LAB3RANGER.c$172$2$136 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:172: PCA0 = PCA_Start;
	mov	((_PCA0 >> 0) & 0xFF),_PCA_Start
	mov	((_PCA0 >> 8) & 0xFF),(_PCA_Start + 1)
	C$LAB3RANGER.c$173$2$136 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:173: CF = 0;
	clr	_CF
	C$LAB3RANGER.c$174$2$136 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:174: count++;
	inc	_count
	clr	a
	cjne	a,_count,00104$
	inc	(_count + 1)
	sjmp	00104$
00102$:
	C$LAB3RANGER.c$177$1$135 ==.
;	C:\SiLabs\LITEC\Lab3\LAB3RANGER.c:177: else PCA0CN &= 0xC0;
	anl	_PCA0CN,#0xc0
00104$:
	pop	psw
	pop	acc
	C$LAB3RANGER.c$179$1$135 ==.
	XG$PCA_ISR$0$0 ==.
	reti
...
;	eliminated unneeded push/pop b
	.area CSEG    (CODE)
	.area CONST   (CODE)
FLAB3RANGER$__str_0$0$0 == .
___str_0:
	.db 0x0a
	.ascii "Type digits; end w/#"
	.db 0x00
FLAB3RANGER$__str_1$0$0 == .
___str_1:
	.ascii "     %c%c%c%c%c"
	.db 0x00
FLAB3RANGER$__str_2$0$0 == .
___str_2:
	.ascii "%c"
	.db 0x00
FLAB3RANGER$__str_3$0$0 == .
___str_3:
	.db 0x0a
	.db 0x0d
	.ascii "Ultrasonic Ranger"
	.db 0x0d
	.db 0x0a
	.db 0x00
FLAB3RANGER$__str_4$0$0 == .
___str_4:
	.ascii "Range: %u"
	.db 0x0a
	.db 0x0d

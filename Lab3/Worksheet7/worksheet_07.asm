...
;--------------------------------------------------------
	...
	C$worksheet_07.c$32$1$41 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:32: unsigned int PW = 5000;           // pulsewidth for speed controller
	mov	_PW,#0x88
	mov	(_PW + 1),#0x13
	C$worksheet_07.c$33$1$41 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:33: unsigned int PCA_start = 10000;   // start count for PCA
	mov	_PCA_start,#0x10
...
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:38: void main()
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$worksheet_07.c$41$1$31 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:41: Sys_Init();            // initial functions in c8051_SDCC.h file
	lcall	_Sys_Init
	C$worksheet_07.c$42$1$31 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:42: putchar(' ');
	mov	dpl,#0x20
	lcall	_putchar
	C$worksheet_07.c$43$1$31 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:43: XBR0_Init();           // initialize XBAR
	lcall	_XBR0_Init
	C$worksheet_07.c$44$1$31 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:44: Interrupt_Init();      // initialize Interrupts
	lcall	_Interrupt_Init
	C$worksheet_07.c$45$1$31 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:45: PCA_Init ();           // initialize PCA
	lcall	_PCA_Init
	C$worksheet_07.c$46$1$31 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:46: printf("\r\n Start    ");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
	C$worksheet_07.c$47$1$31 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:47: printf("\r\n a - increases PCA start count by 1000");
	mov	a,#___str_1
	push	acc
	mov	a,#(___str_1 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
	C$worksheet_07.c$48$1$31 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:48: printf("\r\n s - decreases PCA start count by 1000");
	mov	a,#___str_2
	push	acc
	mov	a,#(___str_2 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
	C$worksheet_07.c$49$1$31 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:49: printf("\r\n k - increases pulse width by 1000");
	mov	a,#___str_3
	push	acc
	mov	a,#(___str_3 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
	C$worksheet_07.c$50$1$31 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:50: printf("\r\n l - decreases pulse width by 1000");
	mov	a,#___str_4
	push	acc
	mov	a,#(___str_4 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
	C$worksheet_07.c$51$1$31 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:51: PCA0CP1 = 65535 - PW; // set initial pulse width
	mov	r4,_PW
	mov	r5,(_PW + 1)
	clr	a
	mov	r6,a
	...
	C$worksheet_07.c$54$1$31 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:54: while(1)
00118$:
	C$worksheet_07.c$56$2$32 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:56: input = getchar();
	lcall	_getchar
	mov	r7,dpl
	C$worksheet_07.c$57$2$32 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:57: if (input == 'a') if (PCA_start < pw_max) PCA_start += 1000;
	cjne	r7,#0x61,00104$
	clr	c
	mov	a,_PCA_start
	subb	a,#0xe8
	...
	mov	(_PCA_start + 1),a
00104$:
	C$worksheet_07.c$58$2$32 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:58: if (input == 's') if (PCA_start > pw_min) PCA_start -= 1000;
	cjne	r7,#0x73,00108$
	clr	c
	mov	a,#0xe8
	subb	a,_PCA_start
	...
	mov	(_PCA_start + 1),a
00108$:
	C$worksheet_07.c$59$2$32 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:59: if (input == 'k')
	cjne	r7,#0x6b,00112$
	C$worksheet_07.c$61$3$33 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:61: if (PW < pw_max) 
	clr	c
	mov	a,_PW
	subb	a,#0xe8
	mov	a,(_PW + 1)
	subb	a,#0xfd
	jnc	00112$
	C$worksheet_07.c$63$4$34 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:63: PW += 1000;
	mov	a,#0xe8
	add	a,_PW
	mov	_PW,a
	mov	a,#0x03
	addc	a,(_PW + 1)
	mov	(_PW + 1),a
	C$worksheet_07.c$64$4$34 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:64: PCA0CP1 = 65536 - PW;  // change pulse width
	mov	r3,_PW
	mov	r4,(_PW + 1)
	clr	a
	mov	r5,a
...
00112$:
	C$worksheet_07.c$69$2$32 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:69: if (input == 'l')
	cjne	r7,#0x6c,00116$
	C$worksheet_07.c$71$3$35 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:71: if (PW > pw_min) 
	clr	c
	mov	a,#0xe8
	subb	a,_PW
	mov	a,#0x03
	subb	a,(_PW + 1)
	jnc	00116$
	C$worksheet_07.c$73$4$36 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:73: PW -= 1000;
	mov	a,_PW
	add	a,#0x18
	mov	_PW,a
	mov	a,(_PW + 1)
	addc	a,#0xfc
	mov	(_PW + 1),a
	C$worksheet_07.c$74$4$36 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:74: PCA0CP1 = 65535 - PW;  // change pulse width
	mov	r4,_PW
	mov	r5,(_PW + 1)
	clr	a
	mov	r6,a
	...
	mov	((_PCA0CP1 >> 8) & 0xFF),r5
00116$:
	C$worksheet_07.c$79$2$32 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:79: printf(" PCA_start = %u  PW = %u      \r\n", PCA_start,PW);
	push	_PW
	push	(_PW + 1)
	push	_PCA_start
	push	(_PCA_start + 1)
...
;------------------------------------------------------------
	G$XBR0_Init$0$0 ==.
	C$worksheet_07.c$84$1$31 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:84: void XBR0_Init()
;	-----------------------------------------
;	 function XBR0_Init
;	-----------------------------------------
_XBR0_Init:
	C$worksheet_07.c$86$1$37 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:86: XBR0 = 0x27;     // set up URART0, SPI, SMB, and CEX 0-3
	mov	_XBR0,#0x27
	C$worksheet_07.c$87$1$37 ==.
	XG$XBR0_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	...
	C$worksheet_07.c$90$1$37 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:90: void Interrupt_Init()
;	-----------------------------------------
;	 function Interrupt_Init
;	-----------------------------------------
_Interrupt_Init:
	C$worksheet_07.c$94$1$38 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:94: EIE1 |= 0x08;    // enable PCA interrupts
	orl	_EIE1,#0x08
	C$worksheet_07.c$95$1$38 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:95: EA = 1;          // enable all interrupts
	setb	_EA
	C$worksheet_07.c$96$1$38 ==.
...
;------------------------------------------------------------
	G$PCA_Init$0$0 ==.
	C$worksheet_07.c$99$1$38 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:99: void PCA_Init()
;	-----------------------------------------
;	 function PCA_Init
;	-----------------------------------------
_PCA_Init:
	C$worksheet_07.c$101$1$39 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:101: PCA0MD = 0x81;   // SYSCLK/12, enable CF interrupts, suspend when idle
	mov	_PCA0MD,#0x81
	C$worksheet_07.c$102$1$39 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:102: PCA0CPM1 = 0xC2; // 16 bit, enable compare, enable PWM
	mov	_PCA0CPM1,#0xc2
	C$worksheet_07.c$103$1$39 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:103: PCA0CN |= 0x40;  // enable PCA
	orl	_PCA0CN,#0x40
	C$worksheet_07.c$104$1$39 ==.
	XG$PCA_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$PCA_ISR$0$0 ==.
	C$worksheet_07.c$107$1$39 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:107: void PCA_ISR(void) __interrupt 9
;	-----------------------------------------
;	 function PCA_ISR
;	-----------------------------------------
_PCA_ISR:
	C$worksheet_07.c$109$1$41 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:109: if (CF)
	jnb	_CF,00102$
	C$worksheet_07.c$111$2$42 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:111: PCA0 = PCA_start;       // start count
	mov	((_PCA0 >> 0) & 0xFF),_PCA_start
	mov	((_PCA0 >> 8) & 0xFF),(_PCA_start + 1)
	C$worksheet_07.c$114$2$42 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:114: CF = 0;                 // Very important - clear interrupt flag
	clr	_CF
	sjmp	00104$
00102$:
	C$worksheet_07.c$116$1$41 ==.
;	C:\SiLabs\LITEC\Lab3\Worksheet7\worksheet_07.c:116: else PCA0CN &= 0xC0;        // all other type 9 interrupts
	anl	_PCA0CN,#0xc0
00104$:
	C$worksheet_07.c$117$1$41 ==.
	XG$PCA_ISR$0$0 ==.
	reti

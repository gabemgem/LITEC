...
;--------------------------------------------------------
	.module Lab32_Compass_GabeMaayan
...
_Data2::
	.ds 3
LLab32_Compass_GabeMaayan.aligned_alloc$size$1$39==.
_aligned_alloc_PARM_2:
	.ds 2
LLab32_Compass_GabeMaayan.lcd_clear$NumBytes$1$85==.
_lcd_clear_NumBytes_1_85:
	.ds 1
LLab32_Compass_GabeMaayan.lcd_clear$Cmd$1$85==.
_lcd_clear_Cmd_1_85:
	.ds 2
LLab32_Compass_GabeMaayan.read_keypad$Data$1$86==.
_read_keypad_Data_1_86:
	.ds 2
LLab32_Compass_GabeMaayan.i2c_write_data$start_reg$1$105==.
_i2c_write_data_PARM_2:
	.ds 1
LLab32_Compass_GabeMaayan.i2c_write_data$buffer$1$105==.
_i2c_write_data_PARM_3:
	.ds 3
LLab32_Compass_GabeMaayan.i2c_write_data$num_bytes$1$105==.
_i2c_write_data_PARM_4:
	.ds 1
LLab32_Compass_GabeMaayan.i2c_read_data$start_reg$1$107==.
_i2c_read_data_PARM_2:
	.ds 1
LLab32_Compass_GabeMaayan.i2c_read_data$buffer$1$107==.
_i2c_read_data_PARM_3:
	.ds 3
LLab32_Compass_GabeMaayan.i2c_read_data$num_bytes$1$107==.
...
_input::
	.ds 1
LLab32_Compass_GabeMaayan.Read_Compass$buffer$1$137==.
...
;--------------------------------------------------------
	.area XSEG    (XDATA)
LLab32_Compass_GabeMaayan.lcd_print$text$1$81==.
...
;--------------------------------------------------------
	...
	C$Lab32_Compass_GabeMaayan.c$20$1$137 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:20: unsigned int PCA_start = 28671;
	mov	_PCA_start,#0xff
	mov	(_PCA_start + 1),#0x6f
	C$Lab32_Compass_GabeMaayan.c$21$1$137 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:21: unsigned int reading=0;
	clr	a
	mov	_reading,a
	mov	(_reading + 1),a
	C$Lab32_Compass_GabeMaayan.c$22$1$137 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:22: unsigned int count = 0;
	mov	_count,a
	mov	(_count + 1),a
	C$Lab32_Compass_GabeMaayan.c$23$1$137 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:23: unsigned int print_count=0;
	mov	_print_count,a
...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$Lab32_Compass_GabeMaayan.c$29$1$113 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:29: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$Lab32_Compass_GabeMaayan.c$33$1$121 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:33: Sys_Init();
	lcall	_Sys_Init
	C$Lab32_Compass_GabeMaayan.c$34$1$121 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:34: putchar(' '); //the quotes in this line may not format correctly
	mov	dpl,#0x20
	lcall	_putchar
	C$Lab32_Compass_GabeMaayan.c$37$1$121 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:37: XBR0_Init();
	lcall	_XBR0_Init
	C$Lab32_Compass_GabeMaayan.c$39$1$121 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:39: PCA_Init();
	lcall	_PCA_Init
	C$Lab32_Compass_GabeMaayan.c$40$1$121 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:40: SMB_Init();
	lcall	_SMB_Init
	C$Lab32_Compass_GabeMaayan.c$41$1$121 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:41: Interrupt_Init();
	lcall	_Interrupt_Init
	C$Lab32_Compass_GabeMaayan.c$43$1$121 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:43: printf("\n\rCompass Reading\n\r");
	mov	a,#___str_3
	push	acc
	mov	a,#(___str_3 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
	C$Lab32_Compass_GabeMaayan.c$44$1$121 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:44: count=0;
	clr	a
	mov	_count,a
	mov	(_count + 1),a
	C$Lab32_Compass_GabeMaayan.c$45$1$121 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:45: while(1) {
00106$:
	C$Lab32_Compass_GabeMaayan.c$46$2$122 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:46: if(count>=2) {//every 40ms
	clr	c
	mov	a,_count
	subb	a,#0x02
	mov	a,(_count + 1)
	subb	a,#0x00
	jc	00106$
	C$Lab32_Compass_GabeMaayan.c$47$3$123 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:47: print_count++;
	inc	_print_count
	clr	a
	cjne	a,_print_count,00120$
	inc	(_print_count + 1)
00120$:
	C$Lab32_Compass_GabeMaayan.c$48$3$123 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:48: Read_Compass();//get compass reading
	lcall	_Read_Compass
	C$Lab32_Compass_GabeMaayan.c$49$3$123 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:49: if(print_count>=25) {//only print results every 1 second
	clr	c
	mov	a,_print_count
	subb	a,#0x19
	...
	subb	a,#0x00
	jc	00102$
	C$Lab32_Compass_GabeMaayan.c$50$4$124 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:50: printf("Reading: %u\n\r", reading);
	push	_reading
	push	(_reading + 1)
	mov	a,#___str_4
	push	acc
	...
	add	a,#0xfb
	mov	sp,a
	C$Lab32_Compass_GabeMaayan.c$51$4$124 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:51: print_count=0;
	clr	a
	mov	_print_count,a
	mov	(_print_count + 1),a
00102$:
	C$Lab32_Compass_GabeMaayan.c$53$3$123 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:53: count=0;
	clr	a
	mov	_count,a
	mov	(_count + 1),a
	sjmp	00106$
	C$Lab32_Compass_GabeMaayan.c$57$1$121 ==.
	XG$main$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$Port_Init$0$0 ==.
	C$Lab32_Compass_GabeMaayan.c$64$1$121 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:64: void Port_Init()//DONT NEED TO INIT PORTS IN THIS PROGRAM
;	-----------------------------------------
;	 function Port_Init
;	-----------------------------------------
_Port_Init:
	C$Lab32_Compass_GabeMaayan.c$68$1$121 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:68: }
	C$Lab32_Compass_GabeMaayan.c$68$1$121 ==.
	XG$Port_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$XBR0_Init$0$0 ==.
	C$Lab32_Compass_GabeMaayan.c$75$1$121 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:75: void XBR0_Init()
;	-----------------------------------------
;	 function XBR0_Init
;	-----------------------------------------
_XBR0_Init:
	C$Lab32_Compass_GabeMaayan.c$77$1$126 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:77: XBR0 = 0x27 ; //configure crossbar with UART, SPI, SMBus, and CEX channels
	mov	_XBR0,#0x27
	C$Lab32_Compass_GabeMaayan.c$78$1$126 ==.
	XG$XBR0_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$SMB_Init$0$0 ==.
	C$Lab32_Compass_GabeMaayan.c$80$1$126 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:80: void SMB_Init(void) {
;	-----------------------------------------
;	 function SMB_Init
;	-----------------------------------------
_SMB_Init:
	C$Lab32_Compass_GabeMaayan.c$81$1$128 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:81: SMB0CR = 0x93; //run at 100kHZ
	mov	_SMB0CR,#0x93
	C$Lab32_Compass_GabeMaayan.c$82$1$128 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:82: ENSMB = 1; //enable smbus
	setb	_ENSMB
	C$Lab32_Compass_GabeMaayan.c$83$1$128 ==.
	XG$SMB_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$PCA_Init$0$0 ==.
	C$Lab32_Compass_GabeMaayan.c$90$1$128 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:90: void PCA_Init(void)
;	-----------------------------------------
;	 function PCA_Init
;	-----------------------------------------
_PCA_Init:
	C$Lab32_Compass_GabeMaayan.c$92$1$130 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:92: PCA0MD = 0x81; //SYSCLK/12, enable CF interrupts, suspend when idle
	mov	_PCA0MD,#0x81
	C$Lab32_Compass_GabeMaayan.c$93$1$130 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:93: PCA0CPM0 = 0xC2; //16 bit, enable compare, enable PWM
	mov	_PCA0CPM0,#0xc2
	C$Lab32_Compass_GabeMaayan.c$94$1$130 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:94: PCA0CN |= 0x40; // enable PCA
	orl	_PCA0CN,#0x40
	C$Lab32_Compass_GabeMaayan.c$95$1$130 ==.
	XG$PCA_Init$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	...
	C$Lab32_Compass_GabeMaayan.c$97$1$130 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:97: void Interrupt_Init(void)
;	-----------------------------------------
;	 function Interrupt_Init
;	-----------------------------------------
_Interrupt_Init:
	C$Lab32_Compass_GabeMaayan.c$99$1$132 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:99: EIE1 |= 0x08;//enable PCA interrupts
	orl	_EIE1,#0x08
	C$Lab32_Compass_GabeMaayan.c$100$1$132 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:100: EA=1;//enable all interrupts
	setb	_EA
	C$Lab32_Compass_GabeMaayan.c$101$1$132 ==.
...
;------------------------------------------------------------
	G$PCA_ISR$0$0 ==.
	C$Lab32_Compass_GabeMaayan.c$108$1$132 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:108: void PCA_ISR ( void ) __interrupt 9
;	-----------------------------------------
;	 function PCA_ISR
;	-----------------------------------------
_PCA_ISR:
	push	acc
	push	psw
	C$Lab32_Compass_GabeMaayan.c$110$1$134 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:110: if(CF) {
	jnb	_CF,00102$
	C$Lab32_Compass_GabeMaayan.c$111$2$135 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:111: PCA0 = PCA_start;//Start count
	mov	((_PCA0 >> 0) & 0xFF),_PCA_start
	mov	((_PCA0 >> 8) & 0xFF),(_PCA_start + 1)
	C$Lab32_Compass_GabeMaayan.c$112$2$135 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:112: CF=0;//clear interrupt flag
	clr	_CF
	C$Lab32_Compass_GabeMaayan.c$113$2$135 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:113: count++;
	inc	_count
	clr	a
	cjne	a,_count,00104$
	inc	(_count + 1)
	sjmp	00104$
00102$:
	C$Lab32_Compass_GabeMaayan.c$115$1$134 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:115: else PCA0CN &= 0xC0;//all other type 9 interrupts
	anl	_PCA0CN,#0xc0
00104$:
	pop	psw
	pop	acc
	C$Lab32_Compass_GabeMaayan.c$116$1$134 ==.
	XG$PCA_ISR$0$0 ==.
	reti
...
;------------------------------------------------------------
	G$Read_Compass$0$0 ==.
	C$Lab32_Compass_GabeMaayan.c$118$1$134 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:118: void Read_Compass(void) {
;	-----------------------------------------
;	 function Read_Compass
;	-----------------------------------------
_Read_Compass:
	C$Lab32_Compass_GabeMaayan.c$120$1$137 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:120: i2c_read_data(0xC0, 2, buffer, 2);//read two bytes starting at reg. 2
	...
	mov	dpl,#0xc0
	lcall	_i2c_read_data
	C$Lab32_Compass_GabeMaayan.c$121$1$137 ==.
;	C:\SiLabs\LITEC\Lab3\Lab32_Compass_GabeMaayan.c:121: reading = (((unsigned int)buffer[0]<<8) | buffer[1]);//combine data
	...
	orl	a,r7
	mov	(_reading + 1),a
	C$Lab32_Compass_GabeMaayan.c$122$1$137 ==.
	XG$Read_Compass$0$0 ==.
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
FLab32_Compass_GabeMaayan$__str_0$0$0 == .
___str_0:
	.db 0x0a
	.ascii "Type digits; end w/#"
	.db 0x00
FLab32_Compass_GabeMaayan$__str_1$0$0 == .
___str_1:
	.ascii "     %c%c%c%c%c"
	.db 0x00
FLab32_Compass_GabeMaayan$__str_2$0$0 == .
___str_2:
	.ascii "%c"
	.db 0x00
FLab32_Compass_GabeMaayan$__str_3$0$0 == .
___str_3:
	.db 0x0a
	.db 0x0d
	...
	.db 0x0d
	.db 0x00
FLab32_Compass_GabeMaayan$__str_4$0$0 == .
___str_4:
	.ascii "Reading: %u"
	.db 0x0a
	.db 0x0d

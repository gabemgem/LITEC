...
S:Llab3compass.lcd_print$fmt$1$80({3}DG,SC:U),B,1,-5
S:Llab3compass.lcd_print$len$1$81({1}SC:U),R,0,0,[r6]
S:Llab3compass.lcd_print$i$1$81({1}SC:U),R,0,0,[]
S:Llab3compass.lcd_print$ap$1$81({1}DD,SC:U),R,0,0,[]
...
S:Llab3compass.getchar$c$1$10({1}SC:U),R,0,0,[]
S:Llab3compass.getchar_nw$c$1$12({1}SC:U),R,0,0,[]
S:G$Data2$0$0({3}DA3d,SC:U),E,0,0
S:Llab3compass.aligned_alloc$size$1$39({2}SI:U),E,0,0
S:Llab3compass.aligned_alloc$alignment$1$39({2}SI:U),E,0,0
S:Llab3compass.lcd_clear$NumBytes$1$85({1}SC:U),E,0,0
S:Llab3compass.lcd_clear$Cmd$1$85({2}DA2d,SC:U),E,0,0
S:Llab3compass.read_keypad$i$1$86({1}SC:U),R,0,0,[r7]
S:Llab3compass.read_keypad$Data$1$86({2}DA2d,SC:U),E,0,0
S:Llab3compass.kpd_input$mode$1$88({1}SC:U),R,0,0,[r7]
S:Llab3compass.kpd_input$sum$1$89({2}SI:U),R,0,0,[r5,r6]
S:Llab3compass.kpd_input$key$1$89({1}SC:U),R,0,0,[r3]
S:Llab3compass.kpd_input$i$1$89({1}SC:U),R,0,0,[]
S:Llab3compass.i2c_write_data$start_reg$1$105({1}SC:U),E,0,0
S:Llab3compass.i2c_write_data$buffer$1$105({3}DG,SC:U),E,0,0
S:Llab3compass.i2c_write_data$num_bytes$1$105({1}SC:U),E,0,0
S:Llab3compass.i2c_write_data$addr$1$105({1}SC:U),R,0,0,[r7]
S:Llab3compass.i2c_write_data$i$1$106({1}SC:U),R,0,0,[]
S:Llab3compass.i2c_read_data$start_reg$1$107({1}SC:U),E,0,0
S:Llab3compass.i2c_read_data$buffer$1$107({3}DG,SC:U),E,0,0
S:Llab3compass.i2c_read_data$num_bytes$1$107({1}SC:U),E,0,0
S:Llab3compass.i2c_read_data$addr$1$107({1}SC:U),R,0,0,[r7]
S:Llab3compass.i2c_read_data$j$1$108({1}SC:U),R,0,0,[]
...
S:Llab3compass.Read_Compass$buffer$1$137({2}DA2d,SC:U),E,0,0
S:Llab3compass.lcd_print$text$1$81({80}DA80d,SC:U),F,0,0
...
S:Flab3compass$__str_0$0$0({22}DA22d,SC:S),D,0,0
S:Flab3compass$__str_1$0$0({16}DA16d,SC:S),D,0,0
S:Flab3compass$__str_2$0$0({3}DA3d,SC:S),D,0,0
S:Flab3compass$__str_3$0$0({20}DA20d,SC:S),D,0,0
S:Flab3compass$__str_4$0$0({14}DA14d,SC:S),D,0,0
